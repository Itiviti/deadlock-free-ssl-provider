...
import com.ullink.security.ssl.CipherSuite.BulkCipher;
import com.ullink.security.ssl.CipherSuite.KeyExchange;
import com.ullink.security.ssl.CipherSuite.MacAlg;
import com.ullink.security.ssl.HandshakeMessage.Finished;
...
abstract class Handshaker {
    ...
    static final boolean allowUnsafeRenegotiation = Debug.getBooleanProperty(
                    "com.ullink.security.ssl.allowUnsafeRenegotiation", false);
    ...
    static final boolean allowLegacyHelloMessages = Debug.getBooleanProperty(
                    "com.ullink.security.ssl.allowLegacyHelloMessages", true);
