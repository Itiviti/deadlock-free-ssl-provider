...
public final class ECKeyFactory extends KeyFactorySpi {
    ...
    static {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            public Void run() {
                p.put("KeyFactory.EC", "ECKeyFactory");
                p.put("AlgorithmParameters.EC", "ECParameters");
    ...
    private static void checkKey(ECKey key) throws InvalidKeyException {
        ...
        if (key instanceof ECPublicKey) {
            ...
            if (key instanceof com.ullink.security.ec.ECPrivateKeyImpl) {
                return;
            }
        } else {
    ...
    private PrivateKey implTranslatePrivateKey(PrivateKey key)
        ...
        if (key instanceof ECPrivateKey) {
            ...
            return new com.ullink.security.ec.ECPrivateKeyImpl(
                ecKey.getS(),
                ecKey.getParams()
            );
        } else if ("PKCS#8".equals(key.getFormat())) {
            return new com.ullink.security.ec.ECPrivateKeyImpl(key.getEncoded());
        } else {
    ...
    private PrivateKey implGeneratePrivate(KeySpec keySpec)
        ...
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            ...
            return new com.ullink.security.ec.ECPrivateKeyImpl(pkcsSpec.getEncoded());
        } else if (keySpec instanceof ECPrivateKeySpec) {
            ECPrivateKeySpec ecSpec = (ECPrivateKeySpec)keySpec;
            return new com.ullink.security.ec.ECPrivateKeyImpl(ecSpec.getS(), ecSpec.getParams());
        } else {
