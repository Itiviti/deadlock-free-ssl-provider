...
package com.ullink.security.ec;
...
public final class ECParameters extends AlgorithmParametersSpi {
    ...
    // Used by SunPKCS11.
    public static com.ullink.security.ec.NamedCurve getNamedCurve(ECParameterSpec params) {
        if ((params instanceof com.ullink.security.ec.NamedCurve) || (params == null)) {
            return (com.ullink.security.ec.NamedCurve)params;
        }
        ...
        for (ECParameterSpec namedCurve : com.ullink.security.ec.NamedCurve.knownECParameterSpecs()) {
            ...
            return (com.ullink.security.ec.NamedCurve)namedCurve;
        }
        // no match found
        return null;
    }
    ...
    public static String getCurveName(ECParameterSpec params) {
        com.ullink.security.ec.NamedCurve curve = getNamedCurve(params);
    ...
    public static ECParameterSpec decodeParameters(byte[] params) throws IOException {
        ...
        if (encodedParams.tag == DerValue.tag_ObjectId) {
            ...
            ECParameterSpec spec = com.ullink.security.ec.NamedCurve.getECParameterSpec(oid);
            if (spec == null) {
...
*/
    ...
    protected void engineInit(AlgorithmParameterSpec paramSpec)
        ...
        if (paramSpec instanceof ECParameterSpec) {
            ...
            ECParameterSpec spec = com.ullink.security.ec.NamedCurve.getECParameterSpec(name);
            if (spec == null) {
