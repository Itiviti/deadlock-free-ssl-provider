...
public final class ECParameters extends AlgorithmParametersSpi {
    ...
    // Used by SunPKCS11.
    public static ullink.security.ec.NamedCurve getNamedCurve(ECParameterSpec params) {
        if ((params instanceof ullink.security.ec.NamedCurve) || (params == null)) {
            return (ullink.security.ec.NamedCurve)params;
        }
        ...
        for (ECParameterSpec namedCurve : ullink.security.ec.NamedCurve.knownECParameterSpecs()) {
            ...
            return (ullink.security.ec.NamedCurve)namedCurve;
        }
        // no match found
        return null;
    }
    ...
    public static String getCurveName(ECParameterSpec params) {
        ullink.security.ec.NamedCurve curve = getNamedCurve(params);
    ...
    public static ECParameterSpec decodeParameters(byte[] params) throws IOException {
        ...
        if (encodedParams.tag == DerValue.tag_ObjectId) {
            ...
            ECParameterSpec spec = ullink.security.ec.NamedCurve.getECParameterSpec(oid);
            if (spec == null) {
...
*/
    ...
    protected void engineInit(AlgorithmParameterSpec paramSpec)
        ...
        if (paramSpec instanceof ECParameterSpec) {
            ...
            ECParameterSpec spec = ullink.security.ec.NamedCurve.getECParameterSpec(name);
            if (spec == null) {
