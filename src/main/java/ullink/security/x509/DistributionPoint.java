...
public class DistributionPoint {
    ...
    private ullink.security.x509.GeneralNames fullName;
    ...
    // crlIssuer or null
    private ullink.security.x509.GeneralNames crlIssuer;
     ...
     */
    public DistributionPoint(ullink.security.x509.GeneralNames fullName, boolean[] reasonFlags,
            ullink.security.x509.GeneralNames crlIssuer) {
        ...
        while ((val.data != null) && (val.data.available() != 0)) {
            ...
            if (opt.isContextSpecific(TAG_DIST_PT) && opt.isConstructed()) {
                ...
                if (distPnt.isContextSpecific(TAG_FULL_NAME)
                    ...
                    fullName = new ullink.security.x509.GeneralNames(distPnt);
                ...
                crlIssuer = new ullink.security.x509.GeneralNames(opt);
            } else {
     ...
     */
    public ullink.security.x509.GeneralNames getFullName() {
        return fullName;
    }
     ...
     */
    public ullink.security.x509.GeneralNames getCRLIssuer() {
        return crlIssuer;
    }
