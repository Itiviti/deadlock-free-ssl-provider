 ...
 * @since 1.4.2
 * @see ullink.security.x509.DistributionPoint
 * @see Extension
...
public class CRLDistributionPointsExtension extends Extension
     ...
     */
    private List<ullink.security.x509.DistributionPoint> distributionPoints;
    ...
    public CRLDistributionPointsExtension(
        List<ullink.security.x509.DistributionPoint> distributionPoints) throws IOException {
    ...
    public CRLDistributionPointsExtension(boolean isCritical,
        ...
        this(ullink.security.x509.PKIXExtensions.CRLDistributionPoints_Id, isCritical,
    ...
    protected CRLDistributionPointsExtension(ObjectIdentifier extensionId,
        boolean isCritical, List<ullink.security.x509.DistributionPoint> distributionPoints,
    ...
    public CRLDistributionPointsExtension(Boolean critical, Object value)
            throws IOException {
        this(ullink.security.x509.PKIXExtensions.CRLDistributionPoints_Id, critical, value, NAME);
    }
    ...
    protected CRLDistributionPointsExtension(ObjectIdentifier extensionId,
        ...
        distributionPoints = new ArrayList<ullink.security.x509.DistributionPoint>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            ullink.security.x509.DistributionPoint point = new ullink.security.x509.DistributionPoint(seq);
    ...
    public void encode(OutputStream out) throws IOException {
        encode(out, ullink.security.x509.PKIXExtensions.CRLDistributionPoints_Id, false);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(POINTS)) {
            ...
            distributionPoints = (List<ullink.security.x509.DistributionPoint>)obj;
        } else {
    ...
    private void encodeThis() throws IOException {
        if (distributionPoints.isEmpty()) {
            ...
            for (ullink.security.x509.DistributionPoint point : distributionPoints) {
                point.encode(pnts);
            }
