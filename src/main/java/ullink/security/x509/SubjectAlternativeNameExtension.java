...
implements ullink.security.x509.CertAttrSet<String> {
     ...
     */
    public SubjectAlternativeNameExtension(ullink.security.x509.GeneralNames names)
    throws IOException {
     ...
     * @exception IOException on error.
     */
    public SubjectAlternativeNameExtension(Boolean critical, ullink.security.x509.GeneralNames names)
    throws IOException {
        this.names = names;
        this.extensionId = ullink.security.x509.PKIXExtensions.SubjectAlternativeName_Id;
    ...
    public SubjectAlternativeNameExtension() {
        extensionId = ullink.security.x509.PKIXExtensions.SubjectAlternativeName_Id;
        critical = false;
        names = new ullink.security.x509.GeneralNames();
    }
    ...
    throws IOException {
        ...
        names = new ullink.security.x509.GeneralNames(val);
    }
    ...
    public String toString() {
        ...
        if(names == null) {
            ...
            for(ullink.security.x509.GeneralName name: names.names()) {
                result += "  "+name+"\n";
            }
        }
        result += "]\n";
