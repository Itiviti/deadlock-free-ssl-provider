...
public class CertificateSerialNumber implements CertAttrSet<String> {
    ...
    private ullink.security.x509.SerialNumber serial;
    ...
    public CertificateSerialNumber(BigInteger num) {
      this.serial = new ullink.security.x509.SerialNumber(num);
    }
    ...
    public CertificateSerialNumber(DerInputStream in) throws IOException {
        serial = new ullink.security.x509.SerialNumber(in);
    }
    ...
    public CertificateSerialNumber(DerValue val) throws IOException {
        serial = new ullink.security.x509.SerialNumber(val);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        ...
        if (name.equalsIgnoreCase(NUMBER)) {
            serial = (ullink.security.x509.SerialNumber)obj;
        } else {
