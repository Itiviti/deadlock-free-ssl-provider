...
import ullink.security.provider.X509Factory;
 ...
 * @see ullink.security.x509.X509CertInfo
 */
public class X509CertImpl extends X509Certificate implements ullink.security.util.DerEncoder {
    ...
    public static final String INFO = ullink.security.x509.X509CertInfo.NAME;
    ...
    public static final String SUBJECT_DN = NAME + DOT + INFO + DOT +
                               ullink.security.x509.X509CertInfo.SUBJECT + DOT +
                               ullink.security.x509.CertificateSubjectName.DN_NAME;
    // x509.info.issuer.dname
    public static final String ISSUER_DN = NAME + DOT + INFO + DOT +
                               ullink.security.x509.X509CertInfo.ISSUER + DOT +
                               ullink.security.x509.CertificateIssuerName.DN_NAME;
    // x509.info.serialNumber.number
    public static final String SERIAL_ID = NAME + DOT + INFO + DOT +
                               ullink.security.x509.X509CertInfo.SERIAL_NUMBER + DOT +
                               ullink.security.x509.CertificateSerialNumber.NUMBER;
    // x509.info.key.value
    public static final String PUBLIC_KEY = NAME + DOT + INFO + DOT +
                               ullink.security.x509.X509CertInfo.KEY + DOT +
                               ullink.security.x509.CertificateX509Key.KEY;

    // x509.info.version.value
    public static final String VERSION = NAME + DOT + INFO + DOT +
                               ullink.security.x509.X509CertInfo.VERSION + DOT +
                               ullink.security.x509.CertificateVersion.VERSION;
    ...
    protected ullink.security.x509.X509CertInfo info = null;
    protected ullink.security.x509.AlgorithmId algId = null;
    ...
    public X509CertImpl(byte[] certData) throws CertificateException {
        try {
            parse(new ullink.security.util.DerValue(certData));
        } catch (IOException e) {
            signedCert = null;
    ...
    public X509CertImpl(InputStream in) throws CertificateException {
        ...
        ullink.security.util.DerValue der = null;
        ...
        try {
            ...
            try {
                ...
                inBuffered.reset();
                der = new ullink.security.util.DerValue(inBuffered);
     ...
     *                     encoded bytes
     */
    private ullink.security.util.DerValue readRFC1421Cert(InputStream in) throws IOException {
        ullink.security.util.DerValue der = null;
        String line = null;
            ...
            try {
                while ((line = certBufferedReader.readLine()) != null) {
                    if (line.equals(X509Factory.END_CERT)) {
                        der = new ullink.security.util.DerValue(decstream.toByteArray());
                        break;
                    } else {
     ...
     *              created from.
     */
    public X509CertImpl(ullink.security.x509.X509CertInfo certInfo) {
        this.info = certInfo;
    }
     ...
     * @exception CertificateException on parsing and initialization errors.
     */
    public X509CertImpl(ullink.security.util.DerValue derVal) throws CertificateException {
        try {
            parse(derVal);
        } catch (IOException e) {
            signedCert = null;
    ...
    throws CertificateException, NoSuchAlgorithmException,
        ...
        try {
            ...
            algId = ullink.security.x509.AlgorithmId.get(sigEngine.getAlgorithm());

            ullink.security.util.DerOutputStream out = new ullink.security.util.DerOutputStream();
            ullink.security.util.DerOutputStream tmp = new ullink.security.util.DerOutputStream();
            ...
            out.write(ullink.security.util.DerValue.tag_Sequence, tmp);
    ...
    throws CertificateExpiredException, CertificateNotYetValidException {
        ...
        ullink.security.x509.CertificateValidity interval = null;
        try {
            interval = (ullink.security.x509.CertificateValidity)info.get(ullink.security.x509.CertificateValidity.NAME);
        } catch (Exception e) {
    ...
    throws CertificateParsingException {
        ullink.security.x509.X509AttributeName attr = new ullink.security.x509.X509AttributeName(name);
        ...
        attr = new ullink.security.x509.X509AttributeName(attr.getSuffix());
        id = attr.getPrefix();
    ...
    throws CertificateException, IOException {
        ...
        if (id.equalsIgnoreCase(INFO)) {
            if (attr.getSuffix() == null) {
                if (!(obj instanceof ullink.security.x509.X509CertInfo)) {
                    throw new CertificateException("Attribute value should"
                                    + " be of type X509CertInfo.");
                }
                info = (ullink.security.x509.X509CertInfo)obj;
    ...
    public Enumeration<String> getElements() {
        ullink.security.x509.AttributeNameEnumeration elements = new ullink.security.x509.AttributeNameEnumeration();
    ...
    public PublicKey getPublicKey() {
        if (info == null)
            return null;
        try {
            PublicKey key = (PublicKey)info.get(ullink.security.x509.CertificateX509Key.NAME
                                + DOT + ullink.security.x509.CertificateX509Key.KEY);
            return key;
        } catch (Exception e) {
            return null;
        }
    ...
    public int getVersion() {
        if (info == null)
            return -1;
        try {
            int vers = ((Integer)info.get(ullink.security.x509.CertificateVersion.NAME
                        + DOT + ullink.security.x509.CertificateVersion.VERSION)).intValue();
            return vers+1;
        } catch (Exception e) {
            return -1;
        }
    ...
    public BigInteger getSerialNumber() {
        ullink.security.x509.SerialNumber ser = getSerialNumberObject();
     ...
     * @return the serial number.
     */
    public ullink.security.x509.SerialNumber getSerialNumberObject() {
        if (info == null)
            return null;
        try {
            ullink.security.x509.SerialNumber ser = (ullink.security.x509.SerialNumber)info.get(
                              ullink.security.x509.CertificateSerialNumber.NAME + DOT +
                              ullink.security.x509.CertificateSerialNumber.NUMBER);
           return ser;
        } catch (Exception e) {
            return null;
    ...
    public Principal getSubjectDN() {
        ...
        try {
            Principal subject = (Principal)info.get(
                                 ullink.security.x509.CertificateSubjectName.NAME + DOT +
                                 ullink.security.x509.CertificateSubjectName.DN_NAME);
            return subject;
        } catch (Exception e) {
            return null;
    ...
    public X500Principal getSubjectX500Principal() {
        ...
        try {
            X500Principal subject = (X500Principal)info.get(
                                ullink.security.x509.CertificateSubjectName.NAME + DOT +
                                ullink.security.x509.CertificateSubjectName.DN_PRINCIPAL);
            return subject;
        } catch (Exception e) {
            return null;
        }
    ...
    public Principal getIssuerDN() {
        ...
        try {
            Principal issuer = (Principal)info.get(
                                ullink.security.x509.CertificateIssuerName.NAME + DOT +
                                ullink.security.x509.CertificateIssuerName.DN_NAME);
            return issuer;
        } catch (Exception e) {
            return null;
    ...
    public X500Principal getIssuerX500Principal() {
        ...
        try {
            X500Principal issuer = (X500Principal)info.get(
                                ullink.security.x509.CertificateIssuerName.NAME + DOT +
                                ullink.security.x509.CertificateIssuerName.DN_PRINCIPAL);
            return issuer;
        } catch (Exception e) {
            return null;
        }
    ...
    public Date getNotBefore() {
        if (info == null)
            return null;
        try {
            Date d = (Date) info.get(ullink.security.x509.CertificateValidity.NAME + DOT +
                                        ullink.security.x509.CertificateValidity.NOT_BEFORE);
            return d;
        } catch (Exception e) {
            return null;
        }
    ...
    public Date getNotAfter() {
        ...
        try {
            Date d = (Date) info.get(ullink.security.x509.CertificateValidity.NAME + DOT +
                                     ullink.security.x509.CertificateValidity.NOT_AFTER);
            return d;
        } catch (Exception e) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        if (algId == null)
            return null;
        ullink.security.util.ObjectIdentifier oid = algId.getOID();
        return (oid.toString());
    }
    ...
    public boolean[] getIssuerUniqueID() {
        if (info == null)
            return null;
        try {
            ullink.security.x509.UniqueIdentity id = (ullink.security.x509.UniqueIdentity)info.get(
                                 ullink.security.x509.CertificateIssuerUniqueIdentity.NAME
                            + DOT + ullink.security.x509.CertificateIssuerUniqueIdentity.ID);
            if (id == null)
                return null;
            else
                return (id.getId());
    ...
    public boolean[] getSubjectUniqueID() {
        ...
        try {
            ullink.security.x509.UniqueIdentity id = (ullink.security.x509.UniqueIdentity)info.get(
                                 ullink.security.x509.CertificateSubjectUniqueIdentity.NAME
                            + DOT + ullink.security.x509.CertificateSubjectUniqueIdentity.ID);
            if (id == null)
                return null;
            else
                return (id.getId());
     ...
     * in certificate)
     */
    public ullink.security.x509.AuthorityKeyIdentifierExtension getAuthorityKeyIdentifierExtension()
    {
        return (ullink.security.x509.AuthorityKeyIdentifierExtension)
            getExtension(ullink.security.x509.PKIXExtensions.AuthorityKey_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.BasicConstraintsExtension getBasicConstraintsExtension() {
        return (ullink.security.x509.BasicConstraintsExtension)
            getExtension(ullink.security.x509.PKIXExtensions.BasicConstraints_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.CertificatePoliciesExtension getCertificatePoliciesExtension() {
        return (ullink.security.x509.CertificatePoliciesExtension)
            getExtension(ullink.security.x509.PKIXExtensions.CertificatePolicies_Id);
    }
     ...
     * in certificate)
     */
    public ullink.security.x509.ExtendedKeyUsageExtension getExtendedKeyUsageExtension() {
        return (ullink.security.x509.ExtendedKeyUsageExtension)
            getExtension(ullink.security.x509.PKIXExtensions.ExtendedKeyUsage_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.IssuerAlternativeNameExtension getIssuerAlternativeNameExtension() {
        return (ullink.security.x509.IssuerAlternativeNameExtension)
            getExtension(ullink.security.x509.PKIXExtensions.IssuerAlternativeName_Id);
    }
     ...
     */
    public ullink.security.x509.NameConstraintsExtension getNameConstraintsExtension() {
        return (ullink.security.x509.NameConstraintsExtension)
            getExtension(ullink.security.x509.PKIXExtensions.NameConstraints_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.PolicyConstraintsExtension getPolicyConstraintsExtension() {
        return (ullink.security.x509.PolicyConstraintsExtension)
            getExtension(ullink.security.x509.PKIXExtensions.PolicyConstraints_Id);
    }
     ...
     * in certificate)
     */
    public ullink.security.x509.PolicyMappingsExtension getPolicyMappingsExtension() {
        return (ullink.security.x509.PolicyMappingsExtension)
            getExtension(ullink.security.x509.PKIXExtensions.PolicyMappings_Id);
    }
     ...
     */
    public ullink.security.x509.PrivateKeyUsageExtension getPrivateKeyUsageExtension() {
        return (ullink.security.x509.PrivateKeyUsageExtension)
            getExtension(ullink.security.x509.PKIXExtensions.PrivateKeyUsage_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.SubjectAlternativeNameExtension getSubjectAlternativeNameExtension()
    {
        return (ullink.security.x509.SubjectAlternativeNameExtension)
            getExtension(ullink.security.x509.PKIXExtensions.SubjectAlternativeName_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.SubjectKeyIdentifierExtension getSubjectKeyIdentifierExtension() {
        return (ullink.security.x509.SubjectKeyIdentifierExtension)
            getExtension(ullink.security.x509.PKIXExtensions.SubjectKey_Id);
    }
     ...
     * certificate)
     */
    public ullink.security.x509.CRLDistributionPointsExtension getCRLDistributionPointsExtension() {
        return (ullink.security.x509.CRLDistributionPointsExtension)
            getExtension(ullink.security.x509.PKIXExtensions.CRLDistributionPoints_Id);
    }
    ...
    public boolean hasUnsupportedCriticalExtension() {
        if (info == null)
            return false;
        try {
            ullink.security.x509.CertificateExtensions exts = (ullink.security.x509.CertificateExtensions)info.get(
                                         ullink.security.x509.CertificateExtensions.NAME);
            if (exts == null)
                return false;
    ...
    public Set<String> getCriticalExtensionOIDs() {
        ...
        try {
            ...
            for (ullink.security.x509.Extension ex : exts.getAllExtensions()) {
                if (ex.isCritical()) {
     ...
     *         extension
     */
    public ullink.security.x509.Extension getExtension(ullink.security.util.ObjectIdentifier oid) {
        if (info == null) {
            return null;
        }
        try {
            ullink.security.x509.CertificateExtensions extensions;
            try {
                extensions = (ullink.security.x509.CertificateExtensions)info.get(ullink.security.x509.CertificateExtensions.NAME);
            ...
            if (extensions == null) {
                ...
                ullink.security.x509.Extension ex = extensions.getExtension(oid.toString());
                if (ex != null) {
                    return ex;
                }
                for (ullink.security.x509.Extension ex2: extensions.getAllExtensions()) {
    ...
    public ullink.security.x509.Extension getUnparseableExtension(ullink.security.util.ObjectIdentifier oid) {
        if (info == null) {
            return null;
        }
        try {
    ...
    public byte[] getExtensionValue(String oid) {
        try {
            ullink.security.util.ObjectIdentifier findOID = new ullink.security.util.ObjectIdentifier(oid);
            String extAlias = ullink.security.x509.OIDMap.getName(findOID);
            ullink.security.x509.Extension certExt = null;
            ullink.security.x509.CertificateExtensions exts = (ullink.security.x509.CertificateExtensions)info.get(
                                     ullink.security.x509.CertificateExtensions.NAME);
            ...
            if (extAlias == null) { // may be unknown
                ...
                for (ullink.security.x509.Extension ex : exts.getAllExtensions()) {
                    ullink.security.util.ObjectIdentifier inCertOID = ex.getExtensionId();
                ...
                try {
                    certExt = (ullink.security.x509.Extension)this.get(extAlias);
                } catch (CertificateException e) {
    ...
    public boolean[] getKeyUsage() {
        try {
            String extAlias = ullink.security.x509.OIDMap.getName(ullink.security.x509.PKIXExtensions.KeyUsage_Id);
            if (extAlias == null)
                return null;

            ullink.security.x509.KeyUsageExtension certExt = (ullink.security.x509.KeyUsageExtension)this.get(extAlias);
            if (certExt == null)
                return null;
    ...
    public synchronized List<String> getExtendedKeyUsage()
        ...
        if (readOnly && extKeyUsage != null) {
            ...
            ullink.security.x509.ExtendedKeyUsageExtension ext = getExtendedKeyUsageExtension();
            if (ext == null) {
                return null;
            }
            extKeyUsage =
    ...
    public static List<String> getExtendedKeyUsage(X509Certificate cert)
        ...
        try {
            ...
            if (ext == null)
                return null;
            ullink.security.util.DerValue val = new ullink.security.util.DerValue(ext);
            byte[] data = val.getOctetString();

            ullink.security.x509.ExtendedKeyUsageExtension ekuExt =
                new ullink.security.x509.ExtendedKeyUsageExtension(Boolean.FALSE, data);
    ...
    public int getBasicConstraints() {
        try {
            String extAlias = ullink.security.x509.OIDMap.getName(ullink.security.x509.PKIXExtensions.BasicConstraints_Id);
            if (extAlias == null)
                return -1;
            ullink.security.x509.BasicConstraintsExtension certExt =
                        (ullink.security.x509.BasicConstraintsExtension)this.get(extAlias);
            if (certExt == null)
                return -1;

            if (((Boolean)certExt.get(ullink.security.x509.BasicConstraintsExtension.IS_CA)
                 ).booleanValue() == true)
                return ((Integer)certExt.get(
                        ullink.security.x509.BasicConstraintsExtension.PATH_LEN)).intValue();
            else
                return -1;
        } catch (Exception e) {
            return -1;
     ...
     */
    private static Collection<List<?>> makeAltNames(ullink.security.x509.GeneralNames names) {
        if (names.isEmpty()) {
            return Collections.<List<?>>emptySet();
        }
        List<List<?>> newNames = new ArrayList<List<?>>();
        for (ullink.security.x509.GeneralName gname : names.names()) {
            ullink.security.x509.GeneralNameInterface name = gname.getName();
            List<Object> nameEntry = new ArrayList<Object>(2);
            nameEntry.add(Integer.valueOf(name.getType()));
            switch (name.getType()) {
            case ullink.security.x509.GeneralNameInterface.NAME_RFC822:
                nameEntry.add(((ullink.security.x509.RFC822Name) name).getName());
                break;
            case ullink.security.x509.GeneralNameInterface.NAME_DNS:
                nameEntry.add(((ullink.security.x509.DNSName) name).getName());
                break;
            case ullink.security.x509.GeneralNameInterface.NAME_DIRECTORY:
                nameEntry.add(((ullink.security.x509.X500Name) name).getRFC2253Name());
                break;
            case ullink.security.x509.GeneralNameInterface.NAME_URI:
                nameEntry.add(((ullink.security.x509.URIName) name).getName());
                break;
            case ullink.security.x509.GeneralNameInterface.NAME_IP:
                try {
                    nameEntry.add(((ullink.security.x509.IPAddressName) name).getName());
                } catch (IOException ioe) {
                ...
                break;
            case ullink.security.x509.GeneralNameInterface.NAME_OID:
                nameEntry.add(((ullink.security.x509.OIDName) name).getOID().toString());
                break;
            default:
                // add DER encoded form
                ullink.security.util.DerOutputStream derOut = new ullink.security.util.DerOutputStream();
                try {
                    name.encode(derOut);
                } catch (IOException ioe) {
    ...
    public synchronized Collection<List<?>> getSubjectAlternativeNames()
        ...
        ullink.security.x509.SubjectAlternativeNameExtension subjectAltNameExt =
            getSubjectAlternativeNameExtension();
        if (subjectAltNameExt == null) {
            return null;
        }
        ullink.security.x509.GeneralNames names;
        try {
            names = (ullink.security.x509.GeneralNames) subjectAltNameExt.get
                (ullink.security.x509.SubjectAlternativeNameExtension.SUBJECT_NAME);
        } catch (IOException ioe) {
            // should not occur
            return Collections.<List<?>>emptySet();
        }
    ...
    public static Collection<List<?>> getSubjectAlternativeNames(X509Certificate cert)
        ...
        try {
            ...
            ullink.security.x509.SubjectAlternativeNameExtension subjectAltNameExt =
                new ullink.security.x509.SubjectAlternativeNameExtension(Boolean.FALSE,
                                                    data);
    ...
    public synchronized Collection<List<?>> getIssuerAlternativeNames()
        ...
        ullink.security.x509.IssuerAlternativeNameExtension issuerAltNameExt =
        ...
        ullink.security.x509.GeneralNames names;
        try {
            names = (ullink.security.x509.GeneralNames) issuerAltNameExt.get
                (ullink.security.x509.IssuerAlternativeNameExtension.ISSUER_NAME);
        } catch (IOException ioe) {
            // should not occur
            return Collections.<List<?>>emptySet();
        }
    ...
    public static Collection<List<?>> getIssuerAlternativeNames(X509Certificate cert)
        ...
        try {
            ...
            ullink.security.x509.IssuerAlternativeNameExtension issuerAltNameExt =
                new ullink.security.x509.IssuerAlternativeNameExtension(Boolean.FALSE,
                                                    data);
            ullink.security.x509.GeneralNames names;
            try {
                names = (ullink.security.x509.GeneralNames) issuerAltNameExt.get
    ...
    public ullink.security.x509.AuthorityInfoAccessExtension getAuthorityInfoAccessExtension() {
        return (ullink.security.x509.AuthorityInfoAccessExtension)
            getExtension(ullink.security.x509.PKIXExtensions.AuthInfoAccess_Id);
    }
     ...
     */
    private void parse(ullink.security.util.DerValue val)
    throws CertificateException, IOException {
        ...
        if (val.data == null || val.tag != ullink.security.util.DerValue.tag_Sequence)
            throw new CertificateParsingException(
                      "invalid DER-encoded certificate data");

        signedCert = val.toByteArray();
        ullink.security.util.DerValue[] seq = new ullink.security.util.DerValue[3];
        ...
        if (seq[0].tag != ullink.security.util.DerValue.tag_Sequence) {
            throw new CertificateParsingException("signed fields invalid");
        }

        algId = ullink.security.x509.AlgorithmId.parse(seq[1]);
        ...
        // The CertificateInfo
        info = new ullink.security.x509.X509CertInfo(seq[0]);

        // the "inner" and "outer" signature algorithms must match
        ullink.security.x509.AlgorithmId infoSigAlg = (ullink.security.x509.AlgorithmId)info.get(
                                              ullink.security.x509.CertificateAlgorithmId.NAME
                                              + DOT +
                                              ullink.security.x509.CertificateAlgorithmId.ALGORITHM);
    ...
    private static X500Principal getX500Principal(X509Certificate cert,
        ...
        ullink.security.util.DerInputStream derIn = new ullink.security.util.DerInputStream(encoded);
        ullink.security.util.DerValue tbsCert = derIn.getSequence(3)[0];
        ullink.security.util.DerInputStream tbsIn = tbsCert.data;
        ullink.security.util.DerValue tmp;
