...
implements ullink.security.x509.CertAttrSet<String> {
    ...
    public CRLNumberExtension(int crlNum) throws IOException {
        this(ullink.security.x509.PKIXExtensions.CRLNumber_Id, false, BigInteger.valueOf(crlNum),
        NAME, LABEL);
    }
    ...
    public CRLNumberExtension(BigInteger crlNum) throws IOException {
        this(ullink.security.x509.PKIXExtensions.CRLNumber_Id, false, crlNum, NAME, LABEL);
    }
    ...
    throws IOException {
        this(ullink.security.x509.PKIXExtensions.CRLNumber_Id, critical, value, NAME, LABEL);
    }
    ...
    public void encode(OutputStream out) throws IOException {
       DerOutputStream  tmp = new DerOutputStream();
        encode(out, ullink.security.x509.PKIXExtensions.CRLNumber_Id, true);
    }
