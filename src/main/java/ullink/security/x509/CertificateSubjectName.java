...
public class CertificateSubjectName implements CertAttrSet<String> {
    ...
    // Private data member
    private ullink.security.x509.X500Name dnName;
     ...
     */
    public CertificateSubjectName(ullink.security.x509.X500Name name) {
        this.dnName = name;
    }
    ...
    public CertificateSubjectName(DerInputStream in) throws IOException {
        dnName = new ullink.security.x509.X500Name(in);
    }
    ...
    public CertificateSubjectName(InputStream in) throws IOException {
        ...
        dnName = new ullink.security.x509.X500Name(derVal);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof ullink.security.x509.X500Name)) {
            throw new IOException("Attribute must be of type X500Name.");
        }
        if (name.equalsIgnoreCase(DN_NAME)) {
            this.dnName = (ullink.security.x509.X500Name)obj;
