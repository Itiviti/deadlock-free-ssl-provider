...
extends Extension implements ullink.security.x509.CertAttrSet<String> {
    /**
     ...
     */
    public IssuerAlternativeNameExtension(ullink.security.x509.GeneralNames names)
    throws IOException {
        this.names = names;
        this.extensionId = ullink.security.x509.PKIXExtensions.IssuerAlternativeName_Id;
        this.critical = false;
        encodeThis();
    }
    ...
    public IssuerAlternativeNameExtension() {
        extensionId = ullink.security.x509.PKIXExtensions.IssuerAlternativeName_Id;
        critical = false;
