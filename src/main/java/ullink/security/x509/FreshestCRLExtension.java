...
public class FreshestCRLExtension extends CRLDistributionPointsExtension {
     ...
     */
    public FreshestCRLExtension(List<ullink.security.x509.DistributionPoint> distributionPoints)
        throws IOException {

        super(ullink.security.x509.PKIXExtensions.FreshestCRL_Id, false, distributionPoints, NAME);
    }
    ...
    throws IOException {
        super(ullink.security.x509.PKIXExtensions.FreshestCRL_Id, critical.booleanValue(), value,
            NAME);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        super.encode(out, ullink.security.x509.PKIXExtensions.FreshestCRL_Id, false);
    }
}
