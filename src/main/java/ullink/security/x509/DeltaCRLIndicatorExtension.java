...
public class DeltaCRLIndicatorExtension extends CRLNumberExtension {
    ...
    public DeltaCRLIndicatorExtension(int crlNum) throws IOException {
        super(ullink.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true,
    ...
    public DeltaCRLIndicatorExtension(BigInteger crlNum) throws IOException {
        super(ullink.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true, crlNum, NAME, LABEL);
    }
    ...
    throws IOException {
        super(ullink.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, critical.booleanValue(),
            value, NAME, LABEL);
    }
    ...
    public void encode(OutputStream out) throws IOException {
       DerOutputStream  tmp = new DerOutputStream();
        super.encode(out, ullink.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true);
    }
}
