...
public class AuthorityInfoAccessExtension extends Extension
     ...
     */
    private List<ullink.security.x509.AccessDescription> accessDescriptions;
    ...
    public AuthorityInfoAccessExtension(
            List<ullink.security.x509.AccessDescription> accessDescriptions) throws IOException {
        this.extensionId = ullink.security.x509.PKIXExtensions.AuthInfoAccess_Id;
        this.critical = false;
    ...
    public AuthorityInfoAccessExtension(Boolean critical, Object value)
        ...
        accessDescriptions = new ArrayList<ullink.security.x509.AccessDescription>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            ullink.security.x509.AccessDescription accessDescription = new ullink.security.x509.AccessDescription(seq);
     ...
     */
    public List<ullink.security.x509.AccessDescription> getAccessDescriptions() {
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(DESCRIPTIONS)) {
            ...
            accessDescriptions = (List<ullink.security.x509.AccessDescription>)obj;
        } else {
    ...
    private void encodeThis() throws IOException {
        if (accessDescriptions.isEmpty()) {
            ...
            for (ullink.security.x509.AccessDescription accessDescription : accessDescriptions) {
