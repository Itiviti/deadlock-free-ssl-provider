 ...
 */
public class OtherName implements ullink.security.x509.GeneralNameInterface {

    private String name;
    private ObjectIdentifier oid;
    private byte[] nameValue = null;
    private ullink.security.x509.GeneralNameInterface gni = null;
     ...
     */
    private ullink.security.x509.GeneralNameInterface getGNI(ObjectIdentifier oid, byte[] nameValue)
            throws IOException {
        try {
            ...
            ullink.security.x509.GeneralNameInterface gni =
                       (ullink.security.x509.GeneralNameInterface)cons.newInstance(passed);
            return gni;
        } catch (Exception e) {
     ...
     */
    public int getType() {
        return ullink.security.x509.GeneralNameInterface.NAME_ANY;
    }
    ...
    public boolean equals(Object other) {
        ...
        ullink.security.x509.GeneralNameInterface otherGNI = null;
        try {
