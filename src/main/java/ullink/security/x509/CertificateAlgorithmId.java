...
public class CertificateAlgorithmId implements CertAttrSet<String> {
    private ullink.security.x509.AlgorithmId algId;
     ...
     * @see ullink.security.x509.AlgorithmId
     */
     ...
     */
    public CertificateAlgorithmId(ullink.security.x509.AlgorithmId algId) {
        this.algId = algId;
    }
    ...
    public CertificateAlgorithmId(DerInputStream in) throws IOException {
        ...
        algId = ullink.security.x509.AlgorithmId.parse(val);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof ullink.security.x509.AlgorithmId)) {
            throw new IOException("Attribute must be of type AlgorithmId.");
        }
        if (name.equalsIgnoreCase(ALGORITHM)) {
            algId = (ullink.security.x509.AlgorithmId)obj;
        } else {
