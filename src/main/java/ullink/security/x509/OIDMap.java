...
public class OIDMap {
    ...
    private static final String ROOT = X509CertImpl.NAME + "." +
                                 ullink.security.x509.X509CertInfo.NAME + "." +
                                 ullink.security.x509.X509CertInfo.EXTENSIONS;
    private static final String AUTH_KEY_IDENTIFIER = ROOT + "." +
                                          ullink.security.x509.AuthorityKeyIdentifierExtension.NAME;
    private static final String SUB_KEY_IDENTIFIER  = ROOT + "." +
                                          ullink.security.x509.SubjectKeyIdentifierExtension.NAME;
    private static final String KEY_USAGE           = ROOT + "." +
                                          ullink.security.x509.KeyUsageExtension.NAME;
    private static final String PRIVATE_KEY_USAGE   = ROOT + "." +
                                          ullink.security.x509.PrivateKeyUsageExtension.NAME;
    private static final String POLICY_MAPPINGS     = ROOT + "." +
                                          ullink.security.x509.PolicyMappingsExtension.NAME;
    private static final String SUB_ALT_NAME        = ROOT + "." +
                                          ullink.security.x509.SubjectAlternativeNameExtension.NAME;
    private static final String ISSUER_ALT_NAME     = ROOT + "." +
                                          ullink.security.x509.IssuerAlternativeNameExtension.NAME;
    private static final String BASIC_CONSTRAINTS   = ROOT + "." +
                                          ullink.security.x509.BasicConstraintsExtension.NAME;
    private static final String NAME_CONSTRAINTS    = ROOT + "." +
                                          ullink.security.x509.NameConstraintsExtension.NAME;
    private static final String POLICY_CONSTRAINTS  = ROOT + "." +
                                          ullink.security.x509.PolicyConstraintsExtension.NAME;
    private static final String CRL_NUMBER  = ROOT + "." +
                                              ullink.security.x509.CRLNumberExtension.NAME;
    private static final String CRL_REASON  = ROOT + "." +
                                              ullink.security.x509.CRLReasonCodeExtension.NAME;
    private static final String NETSCAPE_CERT  = ROOT + "." +
                                              ullink.security.x509.NetscapeCertTypeExtension.NAME;
    private static final String CERT_POLICIES = ROOT + "." +
                                             ullink.security.x509.CertificatePoliciesExtension.NAME;
    private static final String EXT_KEY_USAGE       = ROOT + "." +
                                          ullink.security.x509.ExtendedKeyUsageExtension.NAME;
    private static final String INHIBIT_ANY_POLICY  = ROOT + "." +
                                          ullink.security.x509.InhibitAnyPolicyExtension.NAME;
    private static final String CRL_DIST_POINTS = ROOT + "." +
                                        ullink.security.x509.CRLDistributionPointsExtension.NAME;

    private static final String CERT_ISSUER = ROOT + "." +
                                        ullink.security.x509.CertificateIssuerExtension.NAME;
    private static final String AUTH_INFO_ACCESS = ROOT + "." +
                                          ullink.security.x509.AuthorityInfoAccessExtension.NAME;
    private static final String ISSUING_DIST_POINT = ROOT + "." +
                                        ullink.security.x509.IssuingDistributionPointExtension.NAME;
    private static final String DELTA_CRL_INDICATOR = ROOT + "." +
                                        ullink.security.x509.DeltaCRLIndicatorExtension.NAME;
    private static final String FRESHEST_CRL = ROOT + "." +
                                        ullink.security.x509.FreshestCRLExtension.NAME;
    ...
    static {
        ...
        addInternal(SUB_KEY_IDENTIFIER, ullink.security.x509.PKIXExtensions.SubjectKey_Id,
                    "SubjectKeyIdentifierExtension");
        addInternal(KEY_USAGE, ullink.security.x509.PKIXExtensions.KeyUsage_Id,
                    "KeyUsageExtension");
        addInternal(PRIVATE_KEY_USAGE, ullink.security.x509.PKIXExtensions.PrivateKeyUsage_Id,
                    "PrivateKeyUsageExtension");
        addInternal(SUB_ALT_NAME, ullink.security.x509.PKIXExtensions.SubjectAlternativeName_Id,
                    "SubjectAlternativeNameExtension");
        addInternal(ISSUER_ALT_NAME, ullink.security.x509.PKIXExtensions.IssuerAlternativeName_Id,
                    "IssuerAlternativeNameExtension");
        addInternal(BASIC_CONSTRAINTS, ullink.security.x509.PKIXExtensions.BasicConstraints_Id,
                    "BasicConstraintsExtension");
        addInternal(CRL_NUMBER, ullink.security.x509.PKIXExtensions.CRLNumber_Id,
                    "CRLNumberExtension");
        addInternal(CRL_REASON, ullink.security.x509.PKIXExtensions.ReasonCode_Id,
                    "CRLReasonCodeExtension");
        addInternal(NAME_CONSTRAINTS, ullink.security.x509.PKIXExtensions.NameConstraints_Id,
                    "NameConstraintsExtension");
        addInternal(POLICY_MAPPINGS, ullink.security.x509.PKIXExtensions.PolicyMappings_Id,
                    "PolicyMappingsExtension");
        addInternal(AUTH_KEY_IDENTIFIER, ullink.security.x509.PKIXExtensions.AuthorityKey_Id,
                    "AuthorityKeyIdentifierExtension");
        addInternal(POLICY_CONSTRAINTS, ullink.security.x509.PKIXExtensions.PolicyConstraints_Id,
                    "PolicyConstraintsExtension");
        addInternal(NETSCAPE_CERT, ObjectIdentifier.newInternal
                    (new int[] {2,16,840,1,113730,1,1}),
                    "NetscapeCertTypeExtension");
        addInternal(CERT_POLICIES, ullink.security.x509.PKIXExtensions.CertificatePolicies_Id,
                    "CertificatePoliciesExtension");
        addInternal(EXT_KEY_USAGE, ullink.security.x509.PKIXExtensions.ExtendedKeyUsage_Id,
                    "ExtendedKeyUsageExtension");
        addInternal(INHIBIT_ANY_POLICY, ullink.security.x509.PKIXExtensions.InhibitAnyPolicy_Id,
                    "InhibitAnyPolicyExtension");
        addInternal(CRL_DIST_POINTS, ullink.security.x509.PKIXExtensions.CRLDistributionPoints_Id,
                    "CRLDistributionPointsExtension");
        addInternal(CERT_ISSUER, ullink.security.x509.PKIXExtensions.CertificateIssuer_Id,
                    "CertificateIssuerExtension");
        addInternal(AUTH_INFO_ACCESS, ullink.security.x509.PKIXExtensions.AuthInfoAccess_Id,
                    "AuthorityInfoAccessExtension");
        addInternal(ISSUING_DIST_POINT,
                    ullink.security.x509.PKIXExtensions.IssuingDistributionPoint_Id,
                    "IssuingDistributionPointExtension");
        addInternal(DELTA_CRL_INDICATOR, ullink.security.x509.PKIXExtensions.DeltaCRLIndicator_Id,
                    "DeltaCRLIndicatorExtension");
        addInternal(FRESHEST_CRL, ullink.security.x509.PKIXExtensions.FreshestCRL_Id,
