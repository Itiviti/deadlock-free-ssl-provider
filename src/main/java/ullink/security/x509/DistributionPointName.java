...
public class DistributionPointName {
    ...
    private ullink.security.x509.RDN relativeName = null;
     ...
     */
    public DistributionPointName(ullink.security.x509.RDN relativeName) {
    ...
    public DistributionPointName(DerValue encoding) throws IOException {
        ...
        if (encoding.isContextSpecific(TAG_FULL_NAME) &&
            ...
            relativeName = new ullink.security.x509.RDN(encoding);
     ...
     */
    public ullink.security.x509.RDN getRelativeName() {
        return relativeName;
    }
