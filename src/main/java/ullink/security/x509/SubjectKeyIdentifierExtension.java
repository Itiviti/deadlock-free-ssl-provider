...
implements ullink.security.x509.CertAttrSet<String> {
    ...
    throws IOException {
        id = new ullink.security.x509.KeyIdentifier(octetString);

        this.extensionId = ullink.security.x509.PKIXExtensions.SubjectKey_Id;
        this.critical = false;
        encodeThis();
    }
    ...
    throws IOException {
        ...
        this.id = new ullink.security.x509.KeyIdentifier(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        if (extensionValue == null) {
            extensionId = ullink.security.x509.PKIXExtensions.SubjectKey_Id;
            critical = false;
            encodeThis();
        }
        super.encode(tmp);
