...
public class X509CRLEntryImpl extends X509CRLEntry
    ...
    private ullink.security.x509.SerialNumber serialNumber = null;
    ...
    public X509CRLEntryImpl(BigInteger num, Date date) {
        this.serialNumber = new ullink.security.x509.SerialNumber(num);
     ...
     */
    public X509CRLEntryImpl(BigInteger num, Date date,
                           ullink.security.x509.CRLExtensions crlEntryExts) {
        this.serialNumber = new ullink.security.x509.SerialNumber(num);
        this.revocationDate = date;
    ...
    public Integer getReasonCode() throws IOException {
        Object obj = getExtension(ullink.security.x509.PKIXExtensions.ReasonCode_Id);
        if (obj == null)
            return null;
     ...
     */
    public ullink.security.x509.Extension getExtension(ObjectIdentifier oid) {
        if (extensions == null)
            return null;
    ...
    throws CRLException, IOException {
        ...
        this.serialNumber = new ullink.security.x509.SerialNumber(val);
        ...
        // crlEntryExtensions
        this.extensions = new ullink.security.x509.CRLExtensions(derVal.toDerInputStream());
    }
     ...
     */
    ullink.security.x509.CertificateIssuerExtension getCertificateIssuerExtension() {
        return (ullink.security.x509.CertificateIssuerExtension)
            getExtension(ullink.security.x509.PKIXExtensions.CertificateIssuer_Id);
    }
    @Override
