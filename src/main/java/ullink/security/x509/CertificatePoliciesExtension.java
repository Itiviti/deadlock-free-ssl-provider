...
implements ullink.security.x509.CertAttrSet<String> {
     ...
     */
    private List<ullink.security.x509.PolicyInformation> certPolicies;
    ...
    private void encodeThis() throws IOException {
        if (certPolicies == null || certPolicies.isEmpty()) {
            ...
            for (ullink.security.x509.PolicyInformation info : certPolicies) {
                info.encode(tmp);
            }
     ...
     */
    public CertificatePoliciesExtension(List<ullink.security.x509.PolicyInformation> certPolicies)
    throws IOException {
    ...
    public CertificatePoliciesExtension(Boolean critical,
            List<ullink.security.x509.PolicyInformation> certPolicies) throws IOException {
        this.certPolicies = certPolicies;
        this.extensionId = ullink.security.x509.PKIXExtensions.CertificatePolicies_Id;
    ...
    throws IOException {
        ...
        certPolicies = new ArrayList<ullink.security.x509.PolicyInformation>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            ullink.security.x509.PolicyInformation policy = new ullink.security.x509.PolicyInformation(seq);
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        if (extensionValue == null) {
          extensionId = ullink.security.x509.PKIXExtensions.CertificatePolicies_Id;
          critical = false;
          encodeThis();
        }
        super.encode(tmp);
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(POLICIES)) {
            ...
            certPolicies = (List<ullink.security.x509.PolicyInformation>)obj;
        } else {
