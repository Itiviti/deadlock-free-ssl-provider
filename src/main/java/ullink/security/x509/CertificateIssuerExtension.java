...
public class CertificateIssuerExtension extends Extension
    ...
    private ullink.security.x509.GeneralNames names;
     ...
     */
    public CertificateIssuerExtension(ullink.security.x509.GeneralNames issuer) throws IOException {
        this.extensionId = ullink.security.x509.PKIXExtensions.CertificateIssuer_Id;
        this.critical = true;
        this.names = issuer;
        encodeThis();
    }
    ...
    public CertificateIssuerExtension(Boolean critical, Object value)
        ...
        this.names = new ullink.security.x509.GeneralNames(val);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(ISSUER)) {
            ...
            this.names = (ullink.security.x509.GeneralNames)obj;
        } else {
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        if (extensionValue == null) {
            extensionId = ullink.security.x509.PKIXExtensions.CertificateIssuer_Id;
            critical = true;
            encodeThis();
        }
        super.encode(tmp);
