...
public class CertificateSubjectUniqueIdentity implements CertAttrSet<String> {
    ...
    private ullink.security.x509.UniqueIdentity id;
     ...
     */
    public CertificateSubjectUniqueIdentity(ullink.security.x509.UniqueIdentity id) {
        this.id = id;
    }
    ...
    throws IOException {
        id = new ullink.security.x509.UniqueIdentity(in);
    }
    ...
    throws IOException {
        ...
        id = new ullink.security.x509.UniqueIdentity(val);
    }
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof ullink.security.x509.UniqueIdentity)) {
            throw new IOException("Attribute must be of type UniqueIdentity.");
        }
        if (name.equalsIgnoreCase(ID)) {
            id = (ullink.security.x509.UniqueIdentity)obj;
        } else {
