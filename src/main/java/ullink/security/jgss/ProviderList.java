...
import ullink.security.jgss.wrapper.NativeGSSFactory;
import ullink.security.jgss.wrapper.SunNativeProvider;
...
public final class ProviderList {
    ...
    static {
        ...
        if (defaultOidStr != null) {
            defOid = ullink.security.jgss.GSSUtil.createOid(defaultOidStr);
        }
        DEFAULT_MECH_OID =
            (defOid == null ? ullink.security.jgss.GSSUtil.GSS_KRB5_MECH_OID : defOid);
   }
    ...
    public ProviderList(int caller, boolean useNative) {
        ...
        for (int i = 0; i < provList.length; i++) {
            ...
            try {
                ...
                ullink.security.jgss.GSSUtil.debug("Error in adding provider " +
                        prov.getName() + ": " + ge);
            }
        } // End of for loop
    }
        ...
        while (props.hasMoreElements()) {
            ...
            if (isMechFactoryProperty(prop)) {
                ...
                try {
                    ...
                    ullink.security.jgss.GSSUtil.debug("Ignore the invalid property " +
