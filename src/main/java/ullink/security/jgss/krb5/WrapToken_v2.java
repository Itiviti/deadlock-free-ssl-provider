...
class WrapToken_v2 extends MessageToken_v2 {
     ...
     */
    public WrapToken_v2(ullink.security.jgss.krb5.Krb5Context context,
                     byte[] tokenBytes, int tokenOffset, int tokenLen,
                     MessageProp prop)  throws GSSException {

        // Just parse the MessageToken part first
        super(ullink.security.jgss.krb5.Krb5Token.WRAP_ID_v2, context,
    ...
    public WrapToken_v2(ullink.security.jgss.krb5.Krb5Context context,
        ...
        // Just parse the MessageToken part first
        super(ullink.security.jgss.krb5.Krb5Token.WRAP_ID_v2, context, is, prop);
    ...
    public WrapToken_v2(ullink.security.jgss.krb5.Krb5Context context, MessageProp prop,
    ...
    static int getSizeLimit(int qop, boolean confReq, int maxTokenSize,
        ullink.security.jgss.krb5.CipherHelper ch) throws GSSException {
