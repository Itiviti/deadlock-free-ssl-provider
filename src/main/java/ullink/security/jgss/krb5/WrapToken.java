...
class WrapToken extends MessageToken {
     ...
     */
    public WrapToken(ullink.security.jgss.krb5.Krb5Context context,
                     byte[] tokenBytes, int tokenOffset, int tokenLen,
                     MessageProp prop)  throws GSSException {

        // Just parse the MessageToken part first
        super(ullink.security.jgss.krb5.Krb5Token.WRAP_ID, context,
    ...
    public WrapToken(ullink.security.jgss.krb5.Krb5Context context,
        ...
        // Just parse the MessageToken part first
        super(ullink.security.jgss.krb5.Krb5Token.WRAP_ID, context, is, prop);
    ...
    public WrapToken(ullink.security.jgss.krb5.Krb5Context context, MessageProp prop,
