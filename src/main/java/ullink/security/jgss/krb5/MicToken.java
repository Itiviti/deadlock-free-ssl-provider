...
class MicToken extends MessageToken {
  ...
  public MicToken(ullink.security.jgss.krb5.Krb5Context context,
                  byte[] tokenBytes, int tokenOffset, int tokenLen,
                  MessageProp prop)  throws GSSException {
        super(ullink.security.jgss.krb5.Krb5Token.MIC_ID, context,
  ...
  public MicToken(ullink.security.jgss.krb5.Krb5Context context,
    ...
    throws GSSException {
    super(ullink.security.jgss.krb5.Krb5Token.MIC_ID, context, is, prop);
  }
  ...
  public MicToken(ullink.security.jgss.krb5.Krb5Context context, MessageProp prop,
