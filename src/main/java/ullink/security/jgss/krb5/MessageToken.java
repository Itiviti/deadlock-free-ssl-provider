 ...
 * @author Ram Marti
 * @see ullink.security.jgss.GSSHeader
 */
...
abstract class MessageToken extends Krb5Token {
    ...
    ullink.security.jgss.krb5.CipherHelper cipherHelper = null;
     ...
     */
    MessageToken(int tokenId, ullink.security.jgss.krb5.Krb5Context context,
     ...
     */
    MessageToken(int tokenId, ullink.security.jgss.krb5.Krb5Context context, InputStream is,
                 MessageProp prop) throws GSSException {
     ...
     * @param context the Kerberos context associated with this token
     */
    MessageToken(int tokenId, ullink.security.jgss.krb5.Krb5Context context) throws GSSException {
        /*
          debug("\n============================");
          debug("\nMySessionKey=" +
    ...
    private void init(int tokenId, ullink.security.jgss.krb5.Krb5Context context) throws GSSException {
    ...
    protected static final int getTokenSize(ullink.security.jgss.krb5.CipherHelper ch)
        throws GSSException {
