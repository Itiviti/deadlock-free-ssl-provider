...
public class Krb5AcceptCredential
    ...
    private Krb5AcceptCredential(ullink.security.jgss.krb5.Krb5NameElement name, KerberosKey[] keys) {
        /*
    ...
    static Krb5AcceptCredential getInstance(final int caller, ullink.security.jgss.krb5.Krb5NameElement name)
        throws GSSException {
        ...
        try {
            keys = AccessController.doPrivileged(
                ...
                public KerberosKey[] run() throws Exception {
                    return ullink.security.jgss.krb5.Krb5Util.getKeys(
