...
abstract class MessageToken_v2 extends Krb5Token {
     ...
     */
    MessageToken_v2(int tokenId, ullink.security.jgss.krb5.Krb5Context context,
     ...
     */
    MessageToken_v2(int tokenId, ullink.security.jgss.krb5.Krb5Context context, InputStream is,
                 MessageProp prop) throws GSSException {
     ...
     * @param context the Kerberos context associated with this token
     */
    MessageToken_v2(int tokenId, ullink.security.jgss.krb5.Krb5Context context) throws GSSException {
        /*
          debug("\n============================");
          debug("\nMySessionKey=" +
