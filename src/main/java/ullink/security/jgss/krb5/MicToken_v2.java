...
class MicToken_v2 extends MessageToken_v2 {
    ...
    public MicToken_v2(ullink.security.jgss.krb5.Krb5Context context,
                  byte[] tokenBytes, int tokenOffset, int tokenLen,
                  MessageProp prop)  throws GSSException {
        super(ullink.security.jgss.krb5.Krb5Token.MIC_ID_v2, context,
    ...
    throws GSSException {
        super(ullink.security.jgss.krb5.Krb5Token.MIC_ID_v2, context, is, prop);
    }
    ...
    public MicToken_v2(ullink.security.jgss.krb5.Krb5Context context, MessageProp prop,
    ...
    public MicToken_v2(ullink.security.jgss.krb5.Krb5Context context, MessageProp prop, InputStream data)
