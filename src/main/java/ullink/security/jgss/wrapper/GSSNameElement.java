...
public class GSSNameElement implements GSSNameSpi {
    ...
    private static Oid getNativeNameType(Oid nameType, GSSLibStub stub) {
        if (GSSUtil.NT_GSS_KRB5_PRINCIPAL.equals(nameType) ||
            ...
            try {
                ...
                if (ge.getMajor() == GSSException.BAD_MECH &&
                    ...
                    try {
                        ...
                        // Should never happen
                        ullink.security.jgss.wrapper.SunNativeProvider.debug("Name type list unavailable: " +
                                ge2.getMajorString());
                    }
                } else {
                    ullink.security.jgss.wrapper.SunNativeProvider.debug("Name type list unavailable: " +
            ...
            if (supportedNTs != null) {
                ...
                if (GSSUtil.NT_GSS_KRB5_PRINCIPAL.equals(nameType)) {
                    ullink.security.jgss.wrapper.SunNativeProvider.debug("Override " + nameType +
    ...
    GSSNameElement(byte[] nameBytes, Oid nameType, GSSLibStub stub)
        ...
        ullink.security.jgss.wrapper.SunNativeProvider.debug("Imported " + printableName + " w/ type " +
                printableType);
    }
    ...
    public String getKrbName() throws GSSException {
        ...
        ullink.security.jgss.wrapper.SunNativeProvider.debug("Got kerberized name: " + printables2[0]);
