...
public class GSSNameImpl implements GSSName {
    ...
    GSSNameImpl(GSSManagerImpl gssManager,
        ...
        if (appName == null)
            throw new ullink.security.jgss.GSSExceptionImpl(GSSException.BAD_NAME,
    ...
    public byte[] export() throws GSSException {
        ...
        if (mechElement == null) {
            /* Use default mech */
            mechElement = getElement(ullink.security.jgss.ProviderList.DEFAULT_MECH_OID);
        }
    ...
    private static String getNameTypeStr(Oid nameTypeOid) {
        ...
        if (nameTypeOid.equals(ullink.security.jgss.GSSUtil.NT_GSS_KRB5_PRINCIPAL))
