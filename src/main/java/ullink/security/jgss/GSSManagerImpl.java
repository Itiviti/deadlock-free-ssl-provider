...
public class GSSManagerImpl extends GSSManager {
    ...
    public GSSManagerImpl() {
        list = new ProviderList(ullink.security.jgss.GSSUtil.CALLER_UNKNOWN, USE_NATIVE);
    }
    ...
    public Oid[] getMechsForName(Oid nameType){
        ...
        for (int i = 0; i < mechs.length; i++) {
            ...
            try {
                ...
                ullink.security.jgss.GSSUtil.debug("Skip " + mech +
    ...
    public GSSName createName(String nameStr, Oid nameType)
        throws GSSException {
        return new ullink.security.jgss.GSSNameImpl(this, nameStr, nameType);
    }

    public GSSName createName(byte name[], Oid nameType)
        throws GSSException {
        return new ullink.security.jgss.GSSNameImpl(this, name, nameType);
    }

    public GSSName createName(String nameStr, Oid nameType,
                              Oid mech) throws GSSException {
        return new ullink.security.jgss.GSSNameImpl(this, nameStr, nameType, mech);
    }

    public GSSName createName(byte name[], Oid nameType, Oid mech)
        throws GSSException {
        return new ullink.security.jgss.GSSNameImpl(this, name, nameType, mech);
    }

    public GSSCredential createCredential(int usage)
        throws GSSException {
        return new ullink.security.jgss.GSSCredentialImpl(this, usage);
    }

    public GSSCredential createCredential(GSSName aName,
                                          int lifetime, Oid mech, int usage)
        throws GSSException {
        return new ullink.security.jgss.GSSCredentialImpl(this, aName, lifetime, mech, usage);
    }

    public GSSCredential createCredential(GSSName aName,
                                          int lifetime, Oid mechs[], int usage)
        throws GSSException {
        return new ullink.security.jgss.GSSCredentialImpl(this, aName, lifetime, mechs, usage);
    }

    public GSSContext createContext(GSSName peer, Oid mech,
                                    GSSCredential myCred, int lifetime)
        throws GSSException {
        return new ullink.security.jgss.GSSContextImpl(this, peer, mech, myCred, lifetime);
    }

    public GSSContext createContext(GSSCredential myCred)
        throws GSSException {
        return new ullink.security.jgss.GSSContextImpl(this, myCred);
    }

    public GSSContext createContext(byte[] interProcessToken)
        throws GSSException {
        return new ullink.security.jgss.GSSContextImpl(this, interProcessToken);
    }
