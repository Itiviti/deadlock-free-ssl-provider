...
import ullink.security.jgss.GSSManagerImpl;
import ullink.security.jgss.GSSUtil;
import ullink.security.jgss.SunProvider;
import ullink.security.jgss.krb5.Krb5AcceptCredential;
import ullink.security.jgss.krb5.Krb5InitCredential;
import ullink.security.jgss.krb5.Krb5MechFactory;
import ullink.security.jgss.krb5.Krb5NameElement;
...
public final class SpNegoMechFactory implements MechanismFactory {
    ...
    public GSSContextSpi getMechanismContext(GSSNameSpi peer,
        ...
        if (myInitiatorCred == null) {
            ...
            return new ullink.security.jgss.spnego.SpNegoContext(this, peer, cred, lifetime);
        }
        return new ullink.security.jgss.spnego.SpNegoContext(this, peer, myInitiatorCred, lifetime);
    }
    ...
    public GSSContextSpi getMechanismContext(GSSCredentialSpi myAcceptorCred)
        ...
        if (myAcceptorCred == null) {
            ...
            return new ullink.security.jgss.spnego.SpNegoContext(this, cred);
        }
        return new ullink.security.jgss.spnego.SpNegoContext(this, myAcceptorCred);
    }

    public GSSContextSpi getMechanismContext(byte[] exportedContext)
        throws GSSException {
        // get SpNego mechanism context
        return new ullink.security.jgss.spnego.SpNegoContext(this, exportedContext);
    }
