...
package ullink.security.jgss.spi;
...
public interface MechanismFactory {
     ...
     */
    public ullink.security.jgss.spi.GSSCredentialSpi getCredentialElement(GSSNameSpi name,
     ...
     */
    public ullink.security.jgss.spi.GSSContextSpi getMechanismContext(GSSNameSpi peer,
                                             ullink.security.jgss.spi.GSSCredentialSpi myInitiatorCred,
     ...
     */
    public ullink.security.jgss.spi.GSSContextSpi getMechanismContext(ullink.security.jgss.spi.GSSCredentialSpi myAcceptorCred)
        throws GSSException;
     ...
     */
    public ullink.security.jgss.spi.GSSContextSpi getMechanismContext(byte[] exportedContext)
        throws GSSException;
