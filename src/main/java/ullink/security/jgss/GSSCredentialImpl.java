...
public class GSSCredentialImpl implements GSSCredential {
    ...
    GSSCredentialImpl(ullink.security.jgss.GSSManagerImpl gssManager, int usage)
        throws GSSException {
        this(gssManager, null, GSSCredential.DEFAULT_LIFETIME,
             (Oid[]) null, usage);
    }

    GSSCredentialImpl(ullink.security.jgss.GSSManagerImpl gssManager, GSSName name,
                             int lifetime, Oid mech, int usage)
        throws GSSException {
        if (mech == null) mech = ullink.security.jgss.ProviderList.DEFAULT_MECH_OID;
    ...
    public GSSCredentialImpl(ullink.security.jgss.GSSManagerImpl gssManager,
    ...
    void init(ullink.security.jgss.GSSManagerImpl gssManager) {
    ...
    public GSSName getName() throws GSSException {
        ...
        return ullink.security.jgss.GSSNameImpl.wrapElement(gssManager, tempCred.getName());
    }
    ...
    public GSSName getName(Oid mech) throws GSSException {
        ...
        if (element == null) {
            throw new ullink.security.jgss.GSSExceptionImpl(GSSException.BAD_MECH, mech);
        }

        return ullink.security.jgss.GSSNameImpl.wrapElement(gssManager, element.getName());
    ...
    public void add(GSSName name, int initLifetime, int acceptLifetime,
        ...
        if (hashtable.containsKey(key)) {
            throw new ullink.security.jgss.GSSExceptionImpl(GSSException.DUPLICATE_ELEMENT,
        ...
        GSSNameSpi nameElement = (name == null ? null :
                                  ((ullink.security.jgss.GSSNameImpl)name).getElement(mech));
    ...
    public GSSCredentialSpi getElement(Oid mechOid, boolean initiate)
        ...
        if (mechOid == null) {
             ...
             * desired usage.
             */
            mechOid = ullink.security.jgss.ProviderList.DEFAULT_MECH_OID;
        ...
        if (element == null)
            throw new ullink.security.jgss.GSSExceptionImpl(GSSException.NO_CRED,
