...
import ullink.security.provider.PolicyParser;
import ullink.security.util.PolicyUtil;
import ullink.security.util.PropertyExpander;
import ullink.security.util.PropertyExpander.ExpandException;
    ...
    */
    ...
    void openKeyStore(String name,
        ...
        try {
            ...
            // copied from ullink.security.pkcs11.SunPKCS11
