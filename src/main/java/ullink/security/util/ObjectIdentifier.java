...
class ObjectIdentifier implements Serializable
{
     ...
     */
    public ObjectIdentifier (ullink.security.util.DerInputStream in)
        throws IOException
    {
        byte    type_id;
        int     bufferEnd;
        ...
        if (type_id != ullink.security.util.DerValue.tag_ObjectId)
    ...
    {
        initFromEncoding (new ullink.security.util.DerInputStream(buf), 0);
    }
     ...
     * length are verified.
     */
    private void initFromEncoding (ullink.security.util.DerInputStream in, int bufferEnd)
        throws IOException
    {
     ...
     */
    void encode (ullink.security.util.DerOutputStream out) throws IOException
    {
         ...
         */
        out.write (ullink.security.util.DerValue.tag_ObjectId, bytes);
    }
     ...
     */
    private static int getComponent (ullink.security.util.DerInputStream in)
    throws IOException
    {
        int retval, i, tmp;
     ...
     */
    private static void putComponent (ullink.security.util.DerOutputStream out, int val)
    throws IOException
    {
        int     i;
