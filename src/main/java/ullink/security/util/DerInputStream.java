...
public class DerInputStream {
     ...
     */
    ullink.security.util.DerInputBuffer buffer;
    ...
    private void init(byte[] data, int offset, int len) throws IOException {
        ...
        if (ullink.security.util.DerIndefLenConverter.isIndefinite(data[offset + 1])) {
            byte[] inData = new byte[len];
            System.arraycopy(data, offset, inData, 0, len);

            ullink.security.util.DerIndefLenConverter derIn = new ullink.security.util.DerIndefLenConverter();
            buffer = new ullink.security.util.DerInputBuffer(derIn.convert(inData));
        } else
            buffer = new ullink.security.util.DerInputBuffer(data, offset, len);
        buffer.mark(Integer.MAX_VALUE);
    }

    DerInputStream(ullink.security.util.DerInputBuffer buf) {
        buffer = buf;
        buffer.mark(Integer.MAX_VALUE);
    }
    ...
    throws IOException {
        ullink.security.util.DerInputBuffer newbuf = buffer.dup();
    ...
    public int getInteger() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_Integer) {
    ...
    public int getEnumerated() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_Enumerated) {
    ...
    public byte[] getBitString() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_BitString)
    ...
    public byte[] getOctetString() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_OctetString)
    ...
    public void getNull() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_Null || buffer.read() != 0)
     ...
     */
    public ullink.security.util.ObjectIdentifier getOID() throws IOException {
        return new ullink.security.util.ObjectIdentifier(this);
    }
     ...
     */
    public ullink.security.util.DerValue[] getSequence(int startLen) throws IOException {
        tag = (byte)buffer.read();
        if (tag != ullink.security.util.DerValue.tag_Sequence)
     ...
     * @return array of the values in the sequence
     */
    public ullink.security.util.DerValue[] getSet(int startLen) throws IOException {
        tag = (byte)buffer.read();
        if (tag != ullink.security.util.DerValue.tag_Set)
     ...
     * @return array of the values in the sequence
     */
    public ullink.security.util.DerValue[] getSet(int startLen, boolean implicit)
        throws IOException {
        tag = (byte)buffer.read();
        if (!implicit) {
            if (tag != ullink.security.util.DerValue.tag_Set) {
     ...
     */
    protected ullink.security.util.DerValue[] readVector(int startLen) throws IOException {
        ...
        if (len == -1) {
           ...
           dis.close();
           ullink.security.util.DerIndefLenConverter derIn = new ullink.security.util.DerIndefLenConverter();
           buffer = new ullink.security.util.DerInputBuffer(derIn.convert(indefData));
           if (tag != buffer.read())
        ...
        if (len == 0)
            ...
            return new ullink.security.util.DerValue[0];
         ...
         */
        Vector<ullink.security.util.DerValue> vec = new Vector<ullink.security.util.DerValue>(startLen);
        ullink.security.util.DerValue value;

        do {
            value = new ullink.security.util.DerValue(newstr.buffer);
         ...
         */
        int             i, max = vec.size();
        ullink.security.util.DerValue[]      retval = new ullink.security.util.DerValue[max];
     ...
     */
    public ullink.security.util.DerValue getDerValue() throws IOException {
        return new ullink.security.util.DerValue(buffer);
    }
    ...
    public String getUTF8String() throws IOException {
        return readString(ullink.security.util.DerValue.tag_UTF8String, "UTF-8", "UTF8");
    }
    ...
    public String getPrintableString() throws IOException {
        return readString(ullink.security.util.DerValue.tag_PrintableString, "Printable",
                          "ASCII");
    }
    ...
    public String getT61String() throws IOException {
         ...
         */
        return readString(ullink.security.util.DerValue.tag_T61String, "T61", "ISO-8859-1");
    }
    ...
    public String getIA5String() throws IOException {
        return readString(ullink.security.util.DerValue.tag_IA5String, "IA5", "ASCII");
    }
    ...
    public String getBMPString() throws IOException {
        return readString(ullink.security.util.DerValue.tag_BMPString, "BMP",
                          "UnicodeBigUnmarked");
    }
    ...
    public String getGeneralString() throws IOException {
        return readString(ullink.security.util.DerValue.tag_GeneralString, "General",
                          "ASCII");
    }
    ...
    public Date getUTCTime() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_UtcTime)
    ...
    public Date getGeneralizedTime() throws IOException {
        if (buffer.read() != ullink.security.util.DerValue.tag_GeneralizedTime)
