...
import ullink.security.pkcs.PKCS7;
import ullink.security.pkcs.PKCS9Attribute;
import ullink.security.pkcs.PKCS9Attributes;
import ullink.security.pkcs.SignerInfo;
import ullink.security.timestamp.TimestampToken;
...
public class SignatureFileVerifier {
    ...
    private static final String ATTR_DIGEST =
        ("-DIGEST-" + ullink.security.util.ManifestDigester.MF_MAIN_ATTRS).toUpperCase
        (Locale.ENGLISH);
    ...
    private ullink.security.util.ManifestDigester md;
         ...
         throws IOException
    {
        ...
        ullink.security.util.ManifestDigester.Entry mde = md.get(name,block.isOldStyle());
