...
public class LastReqEntry {
    private int lrType;
    private ullink.security.krb5.internal.KerberosTime lrValue;

    private LastReqEntry() {
    }

    public LastReqEntry(int Type, ullink.security.krb5.internal.KerberosTime time){
        lrType = Type;
        lrValue = time;
    ...
    public LastReqEntry(DerValue encoding) throws Asn1Exception, IOException {
        ...
        lrValue = ullink.security.krb5.internal.KerberosTime.parse(encoding.getData(), (byte) 0x01, false);
    ...
    public Object clone() {
        ...
        newEntry.lrValue = (ullink.security.krb5.internal.KerberosTime)lrValue.clone();
        return newEntry;
    }
}
