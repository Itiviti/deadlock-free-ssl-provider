...
public class APReq {
        public int pvno;
        public int msgType;
        public ullink.security.krb5.internal.APOptions apOptions;
        public ullink.security.krb5.internal.Ticket ticket;
        public EncryptedData authenticator;

        public APReq(
                ullink.security.krb5.internal.APOptions new_apOptions,
                ...
                msgType = ullink.security.krb5.internal.Krb5.KRB_AP_REQ;
    ...
    public APReq(DerValue encoding) throws Asn1Exception, IOException, KrbApErrException, RealmException {
        ...
        private void init(DerValue encoding) throws Asn1Exception,
           IOException, KrbApErrException, RealmException {
                DerValue der, subDer;
        if (((encoding.getTag() & (byte)0x1F) != ullink.security.krb5.internal.Krb5.KRB_AP_REQ)
        ...
        if (pvno != ullink.security.krb5.internal.Krb5.PVNO)
                ...
                if (msgType != ullink.security.krb5.internal.Krb5.KRB_AP_REQ)
                         throw new KrbApErrException(ullink.security.krb5.internal.Krb5.KRB_AP_ERR_MSG_TYPE);
                apOptions = ullink.security.krb5.internal.APOptions.parse(der.getData(), (byte) 0x02, false);
                ticket = ullink.security.krb5.internal.Ticket.parse(der.getData(), (byte) 0x03, false);
