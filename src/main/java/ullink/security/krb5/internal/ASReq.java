...
public class ASReq extends KDCReq {
        ...
        public ASReq(ullink.security.krb5.internal.PAData[] new_pAData, ullink.security.krb5.internal.KDCReqBody new_reqBody) throws IOException {
                super(new_pAData, new_reqBody, ullink.security.krb5.internal.Krb5.KRB_AS_REQ);
        }
    ...
    public ASReq(DerValue encoding) throws Asn1Exception, KrbException, IOException {
        ...
        private void init(DerValue encoding) throws Asn1Exception, IOException, KrbException {
                super.init(encoding, ullink.security.krb5.internal.Krb5.KRB_AS_REQ);
        }
