...
public class EncASRepPart extends EncKDCRepPart {
        ...
        public EncASRepPart(
                ...
                super(
                        ...
                        new_sname,
                        new_caddr,
                        ullink.security.krb5.internal.Krb5.KRB_ENC_AS_REP_PART
                        //may need to use Krb5.KRB_ENC_TGS_REP_PART to mimic
                        //behavior of other implementaions, instead of above
                );
        }

        public EncASRepPart(byte[] data) throws ullink.security.krb5.Asn1Exception,
                IOException, ullink.security.krb5.KrbException {
         init(new DerValue(data));
        }

        public EncASRepPart(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
                IOException, ullink.security.krb5.KrbException {
                init(encoding);
        }
        ...
        private void init(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
                IOException, ullink.security.krb5.KrbException {
                init(encoding, ullink.security.krb5.internal.Krb5.KRB_ENC_AS_REP_PART);
        }

        public byte[] asn1Encode() throws ullink.security.krb5.Asn1Exception,
                IOException {
                return asn1Encode(ullink.security.krb5.internal.Krb5.KRB_ENC_AS_REP_PART);
        }
