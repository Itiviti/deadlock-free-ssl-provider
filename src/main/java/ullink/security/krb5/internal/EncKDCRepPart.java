...
public class EncKDCRepPart {
        ...
        public int nonce;
        public ullink.security.krb5.internal.KerberosTime keyExpiration; //optional
        public ullink.security.krb5.internal.TicketFlags flags;
        public ullink.security.krb5.internal.KerberosTime authtime;
        public ullink.security.krb5.internal.KerberosTime starttime; //optional
        public ullink.security.krb5.internal.KerberosTime endtime;
        public ullink.security.krb5.internal.KerberosTime renewTill; //optional
        public ullink.security.krb5.Realm srealm;
        public ullink.security.krb5.PrincipalName sname;
         ...
         * @exception ullink.security.krb5.RealmException if an error occurs while decoding an Realm object.
         */
        ...
        if (msgType != ullink.security.krb5.internal.Krb5.KRB_ENC_AS_REP_PART &&
                        msgType != ullink.security.krb5.internal.Krb5.KRB_ENC_TGS_REP_PART)
            throw new ullink.security.krb5.Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
                der = encoding.getData().getDerValue();
        if (der.getTag() != DerValue.tag_Sequence)
            throw new ullink.security.krb5.Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
                key = ullink.security.krb5.EncryptionKey.parse(der.getData(), (byte) 0x00, false);
                ...
                keyExpiration = ullink.security.krb5.internal.KerberosTime.parse(der.getData(), (byte) 0x03, true);
                flags = ullink.security.krb5.internal.TicketFlags.parse(der.getData(), (byte) 0x04, false);
                authtime =      ullink.security.krb5.internal.KerberosTime.parse(der.getData(), (byte) 0x05, false);
                starttime = ullink.security.krb5.internal.KerberosTime.parse(der.getData(), (byte) 0x06, true);
                endtime = ullink.security.krb5.internal.KerberosTime.parse(der.getData(), (byte) 0x07, false);
                renewTill = ullink.security.krb5.internal.KerberosTime.parse(der.getData(), (byte) 0x08, true);
                srealm = ullink.security.krb5.Realm.parse(der.getData(), (byte) 0x09, false);
                sname = ullink.security.krb5.PrincipalName.parse(der.getData(), (byte) 0x0A, false);
                if (der.getData().available() > 0)
                        caddr = ullink.security.krb5.internal.HostAddresses.parse(der.getData(), (byte) 0x0B, true);
                if (der.getData().available() > 0)
                        throw new ullink.security.krb5.Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
        }
         ...
         * @exception IOException if an I/O error occurs while reading encoded data.
         */
        public byte[] asn1Encode(int rep_type) throws ullink.security.krb5.Asn1Exception,
                IOException {
