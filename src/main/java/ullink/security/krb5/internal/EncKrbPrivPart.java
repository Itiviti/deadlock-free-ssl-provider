...
public class EncKrbPrivPart {
        ...
        public ullink.security.krb5.internal.HostAddress sAddress; //optional
        ...
        if (der.getTag() != DerValue.tag_Sequence)
            throw new Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
                ...
                sAddress = ullink.security.krb5.internal.HostAddress.parse(der.getData(), (byte) 0x04, false);
                if (der.getData().available() > 0) {
                        rAddress = ullink.security.krb5.internal.HostAddress.parse(der.getData(), (byte) 0x05, true);
                }
                if (der.getData().available() > 0)
                        throw new Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
        }
