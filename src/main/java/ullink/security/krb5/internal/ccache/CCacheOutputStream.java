...
import ullink.security.krb5.internal.TicketFlags;
import ullink.security.krb5.internal.util.KrbDataOutputStream;
...
public class CCacheOutputStream extends KrbDataOutputStream implements FileCCacheConstants {
    ...
    */
    public void addCreds(ullink.security.krb5.internal.ccache.Credentials creds) throws IOException, Asn1Exception {
