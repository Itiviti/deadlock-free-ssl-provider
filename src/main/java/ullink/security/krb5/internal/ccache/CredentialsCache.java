...
public abstract class CredentialsCache {
    ...
    public abstract void update(ullink.security.krb5.internal.ccache.Credentials c);
    public abstract void save() throws IOException, KrbException;
    public abstract ullink.security.krb5.internal.ccache.Credentials[] getCredsList();
    public abstract ullink.security.krb5.internal.ccache.Credentials getDefaultCreds();
    public abstract ullink.security.krb5.internal.ccache.Credentials getCreds(PrincipalName sname, Realm srealm) ;
    public abstract ullink.security.krb5.internal.ccache.Credentials getCreds(LoginOptions options, PrincipalName sname, Realm srealm) ;
}
