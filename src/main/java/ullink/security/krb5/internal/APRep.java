...
public class APRep {
        ...
        public APRep(EncryptedData new_encPart) {
                ...
                msgType = ullink.security.krb5.internal.Krb5.KRB_AP_REP;
                encPart = new_encPart;
        }
    ...
    private void init(DerValue encoding) throws Asn1Exception,
            KrbApErrException, IOException {
                ...
                if (((encoding.getTag() & (byte)(0x1F)) != ullink.security.krb5.internal.Krb5.KRB_AP_REP)
        ...
        if (pvno != ullink.security.krb5.internal.Krb5.PVNO)
            ...
            throw new Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
                ...
                if (msgType != ullink.security.krb5.internal.Krb5.KRB_AP_REP)
