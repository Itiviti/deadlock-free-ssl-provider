...
public class KRBSafeBody {
    ...
    public ullink.security.krb5.internal.HostAddress sAddress;
    public ullink.security.krb5.internal.HostAddress rAddress; //optional
    ...
    public KRBSafeBody(
                       ...
                       ullink.security.krb5.internal.HostAddress new_rAddress
                           ) {
    ...
    public KRBSafeBody(DerValue encoding) throws Asn1Exception, IOException {
        ...
        sAddress = ullink.security.krb5.internal.HostAddress.parse(encoding.getData(), (byte) 0x04, false);
        if (encoding.getData().available() > 0)
            rAddress = ullink.security.krb5.internal.HostAddress.parse(encoding.getData(), (byte) 0x05, true);
        if (encoding.getData().available() > 0)
            throw new Asn1Exception(ullink.security.krb5.internal.Krb5.ASN1_BAD_ID);
    }
