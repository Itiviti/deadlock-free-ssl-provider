...
public class TGSRep extends KDCRep {
    ...
    public TGSRep(
        ...
        super(new_pAData, new_crealm, new_cname, new_ticket,
              new_encPart, ullink.security.krb5.internal.Krb5.KRB_TGS_REP);
    }

    public TGSRep(byte[] data) throws ullink.security.krb5.Asn1Exception,
            ullink.security.krb5.RealmException, ullink.security.krb5.internal.KrbApErrException, IOException {
        init(new DerValue(data));
    }

    public TGSRep(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
            ullink.security.krb5.RealmException, ullink.security.krb5.internal.KrbApErrException, IOException {
        init(encoding);
    }
    ...
    private void init(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
            ullink.security.krb5.RealmException, ullink.security.krb5.internal.KrbApErrException, IOException {
        init(encoding, ullink.security.krb5.internal.Krb5.KRB_TGS_REP);
    }
