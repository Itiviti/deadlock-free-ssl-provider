...
public class KeyTabOutputStream extends KrbDataOutputStream implements KeyTabConstants {
    private ullink.security.krb5.internal.ktab.KeyTabEntry entry;
    private int keyType;
    ...
    public void writeEntry(ullink.security.krb5.internal.ktab.KeyTabEntry entry) throws IOException {
