...
public class KeyTabInputStream extends KrbDataInputStream implements KeyTabConstants {
    ...
    ullink.security.krb5.internal.ktab.KeyTabEntry readEntry(int entryLen, int ktVersion) throws IOException, RealmException {
        index = entryLen;
        ...
        return new ullink.security.krb5.internal.ktab.KeyTabEntry(service, realm, timeStamp, keyVersion, keyType, keyblock);
    }
