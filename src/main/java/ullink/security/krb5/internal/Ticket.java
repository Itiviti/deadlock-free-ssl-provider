...
public class Ticket implements Cloneable {
    public int tkt_vno;
    public ullink.security.krb5.Realm realm;
    ...
    public Object clone() {
        ...
        new_ticket.realm = (ullink.security.krb5.Realm)realm.clone();
        new_ticket.sname = (ullink.security.krb5.PrincipalName)sname.clone();
        new_ticket.encPart = (ullink.security.krb5.EncryptedData)encPart.clone();
    ...
    public Ticket(
        ...
        tkt_vno = ullink.security.krb5.internal.Krb5.TICKET_VNO;
        realm = new_realm;
        sname = new_sname;
        encPart = new_encPart;
    }

    public Ticket(byte[] data) throws ullink.security.krb5.Asn1Exception,
            ullink.security.krb5.RealmException, KrbApErrException, IOException {
        init(new DerValue(data));
    }

    public Ticket(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
            ullink.security.krb5.RealmException, KrbApErrException, IOException {
        init(encoding);
    }
    ...
    private void init(DerValue encoding) throws ullink.security.krb5.Asn1Exception,
        ...
        DerValue der;
        DerValue subDer;
        if (((encoding.getTag() & (byte)0x1F) != ullink.security.krb5.internal.Krb5.KRB_TKT)
        ...
        if (tkt_vno != ullink.security.krb5.internal.Krb5.TICKET_VNO)
            throw new KrbApErrException(ullink.security.krb5.internal.Krb5.KRB_AP_ERR_BADVERSION);
        realm = ullink.security.krb5.Realm.parse(der.getData(), (byte) 0x01, false);
        sname = ullink.security.krb5.PrincipalName.parse(der.getData(), (byte) 0x02, false);
        encPart = ullink.security.krb5.EncryptedData.parse(der.getData(), (byte) 0x03, false);
     ...
     *
     * @exception ullink.security.krb5.Asn1Exception on error.
     * @param data the Der input stream value, which contains one or more marshaled value.
     * @param explicitTag tag number.
     * @param optional indicate if this data field is optional
     * @return an instance of Ticket.
     */
    public static Ticket parse(DerInputStream data, byte explicitTag, boolean optional) throws ullink.security.krb5.Asn1Exception, IOException, ullink.security.krb5.RealmException, KrbApErrException {
