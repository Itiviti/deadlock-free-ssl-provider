...
import ullink.security.krb5.Checksum;
import ullink.security.krb5.Config;
import ullink.security.krb5.KrbCryptoException;
...
public abstract class CksumType {
    ...
    public static CksumType getInstance(int cksumTypeConst)
        ...
        case Checksum.CKSUMTYPE_CRC32:
            ...
            cksumTypeName = "Crc32CksumType";
            break;
        case Checksum.CKSUMTYPE_DES_MAC:
            cksumType = new ullink.security.krb5.internal.crypto.DesMacCksumType();
            cksumTypeName = "DesMacCksumType";
            break;
        case Checksum.CKSUMTYPE_DES_MAC_K:
            cksumType = new ullink.security.krb5.internal.crypto.DesMacKCksumType();
            cksumTypeName =
                "DesMacKCksumType";
            break;
        case Checksum.CKSUMTYPE_RSA_MD5:
            cksumType = new ullink.security.krb5.internal.crypto.RsaMd5CksumType();
            cksumTypeName = "RsaMd5CksumType";
            break;
        case Checksum.CKSUMTYPE_RSA_MD5_DES:
            cksumType = new ullink.security.krb5.internal.crypto.RsaMd5DesCksumType();
            cksumTypeName =
                "RsaMd5DesCksumType";
            break;

        case Checksum.CKSUMTYPE_HMAC_SHA1_DES3_KD:
            cksumType = new ullink.security.krb5.internal.crypto.HmacSha1Des3KdCksumType();
            cksumTypeName =
                "HmacSha1Des3KdCksumType";
            break;

        case Checksum.CKSUMTYPE_HMAC_SHA1_96_AES128:
            cksumType = new ullink.security.krb5.internal.crypto.HmacSha1Aes128CksumType();
            cksumTypeName =
                "HmacSha1Aes128CksumType";
            break;
        case Checksum.CKSUMTYPE_HMAC_SHA1_96_AES256:
            cksumType = new ullink.security.krb5.internal.crypto.HmacSha1Aes256CksumType();
            cksumTypeName =
                "HmacSha1Aes256CksumType";
            break;

        case Checksum.CKSUMTYPE_HMAC_MD5_ARCFOUR:
            cksumType = new ullink.security.krb5.internal.crypto.HmacMd5ArcFourCksumType();
            cksumTypeName =
