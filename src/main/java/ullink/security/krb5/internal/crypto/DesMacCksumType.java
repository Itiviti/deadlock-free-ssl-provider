...
import ullink.security.krb5.Confounder;
...
public class DesMacCksumType extends CksumType {
    ...
    public byte[] calculateKeyedChecksum(byte[] data, int size, byte[] key,
        ...
        byte[] residue = ullink.security.krb5.internal.crypto.Des.des_cksum(residue_ivec, new_data, key);
        ...
        ullink.security.krb5.internal.crypto.Des.cbc_encrypt(cksum, enc_cksum, new_key, ivec, true);
        return enc_cksum;
    }
    ...
    public boolean verifyKeyedChecksum(byte[] data, int size,
        ...
        byte[] new_cksum = ullink.security.krb5.internal.crypto.Des.des_cksum(ivec, new_data, key);
    ...
    private byte[] decryptKeyedChecksum(byte[] enc_cksum, byte[] key) throws KrbCryptoException {
        ...
        ullink.security.krb5.internal.crypto.Des.cbc_encrypt(enc_cksum, cksum, new_key, ivec, false);
        return cksum;
    }
