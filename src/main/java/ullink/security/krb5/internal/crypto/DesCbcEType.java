...
abstract class DesCbcEType extends EType {
    ...
    public byte[] encrypt(byte[] data, byte[] key, byte[] ivec,
        ...
        ullink.security.krb5.internal.crypto.Des.cbc_encrypt(new_data, cipher, key, ivec, true);
        return cipher;
    }
    ...
    public byte[] decrypt(byte[] cipher, byte[] key, byte[] ivec, int usage)
        ...
        ullink.security.krb5.internal.crypto.Des.cbc_encrypt(cipher, data, key, ivec, false);
