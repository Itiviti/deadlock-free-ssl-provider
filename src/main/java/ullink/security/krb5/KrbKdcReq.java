...
import ullink.security.krb5.internal.TCPClient;
import ullink.security.krb5.internal.UDPClient;
...
public abstract class KrbKdcReq {
    ...
    static {
        ...
        int timeout = -1;
        try {
            ullink.security.krb5.Config cfg = ullink.security.krb5.Config.getInstance();
    ...
    private int getKdcTimeout(String realm)
    {
        ...
        try {
            String temp =
               ullink.security.krb5.Config.getInstance().getDefault("kdc_timeout", realm);
