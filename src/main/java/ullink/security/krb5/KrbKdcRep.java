...
abstract class KrbKdcRep {
    ...
    static void check(
                      ullink.security.krb5.internal.KDCReq req,
                      ullink.security.krb5.internal.KDCRep rep
        ...
        *****/
        ...
        if (req.reqBody.kdcOptions.get(ullink.security.krb5.internal.KDCOptions.RENEWABLE) !=
            rep.encKDCRepPart.flags.get(ullink.security.krb5.internal.KDCOptions.RENEWABLE)) {
            throw new ullink.security.krb5.internal.KrbApErrException(ullink.security.krb5.internal.Krb5.KRB_AP_ERR_MODIFIED);
        }
        ...
        if (req.reqBody.kdcOptions.get(ullink.security.krb5.internal.KDCOptions.RENEWABLE_OK) &&
            rep.encKDCRepPart.flags.get(ullink.security.krb5.internal.KDCOptions.RENEWABLE))
            if (!req.reqBody.till.isZero())
                                // verify this is required
                if ((rep.encKDCRepPart.renewTill == null) ||
