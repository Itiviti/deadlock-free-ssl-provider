...
public class PrincipalName
    ...
    private ullink.security.krb5.Realm nameRealm;  // optional; a null realm means use default
    ...
    public Object clone() {
        ...
        if (nameRealm != null) {
            pName.nameRealm = (ullink.security.krb5.Realm)nameRealm.clone();
        }
        return pName;
    }
     ...
     * @exception ullink.security.krb5.Asn1Exception if an error occurs while decoding
     * an ASN1 encoded data.
     * @exception ullink.security.krb5.Asn1Exception if there is an ASN1 encoding error
    ...
    public PrincipalName(String name, int type)
        ...
        ullink.security.krb5.Realm tempRealm = null;
        String realmString = ullink.security.krb5.Realm.parseRealmAtSeparator(name);
        ...
        if (realmString != null)
            tempRealm = new ullink.security.krb5.Realm(realmString);
        ...
        case KRB_NT_SRV_HST:
            ...
            if (mapRealm != null) {
                nameRealm = new ullink.security.krb5.Realm(mapRealm);
            } else {
                nameRealm = tempRealm;
            }
            break;
    ...
    public PrincipalName(String name, String realm) throws RealmException {
        this(name, KRB_NT_UNKNOWN);
        nameRealm = new ullink.security.krb5.Realm(realm);
    }
    ...
    public ullink.security.krb5.Realm getRealm() {
        return nameRealm;
    }

    public void setRealm(ullink.security.krb5.Realm new_nameRealm) throws RealmException {
        nameRealm = new_nameRealm;
    }

    public void setRealm(String realmsString) throws RealmException {
        nameRealm = new ullink.security.krb5.Realm(realmsString);
    }
    ...
    protected PrincipalName(String primary, String instance, String realm,
        ...
        if (type != KRB_NT_SRV_INST) {
            throw new ullink.security.krb5.KrbException(Krb5.KRB_ERR_GENERIC, "Bad name type");
        }
        ...
        this.nameRealm = new ullink.security.krb5.Realm(realm);
        this.nameType = type;
    }
    ...
    static String mapHostToRealm(String name) {
        ...
        try {
            String subname = null;
            ullink.security.krb5.Config c = ullink.security.krb5.Config.getInstance();
