...
abstract class KrbAppMessage {
     ...
     */
    void check(ullink.security.krb5.internal.KerberosTime packetTimestamp,
               Integer packetUsec,
               Integer packetSeqNumber,
               ullink.security.krb5.internal.HostAddress packetSAddress,
               ullink.security.krb5.internal.HostAddress packetRAddress,
               ...
               ullink.security.krb5.Realm packetRealm)
        throws ullink.security.krb5.internal.KrbApErrException {

        if (!ullink.security.krb5.internal.Krb5.AP_EMPTY_ADDRESSES_ALLOWED || sAddress != null) {
        ...
        if (!ullink.security.krb5.internal.Krb5.AP_EMPTY_ADDRESSES_ALLOWED || rAddress != null) {
        ...
        if (seqNumber == null && seqNumberRequired == true)
            throw new ullink.security.krb5.internal.KrbApErrException(ullink.security.krb5.internal.Krb5.API_INVALID_ARG);

        if (packetSeqNumber != null && seqNumber != null) {
            if (packetSeqNumber.intValue() != seqNumber.current())
                throw new ullink.security.krb5.internal.KrbApErrException(ullink.security.krb5.internal.Krb5.KRB_AP_ERR_BADORDER);
        ...
        if (packetTimestamp == null && packetSeqNumber == null)
            throw new ullink.security.krb5.internal.KrbApErrException(ullink.security.krb5.internal.Krb5.KRB_AP_ERR_MODIFIED);
