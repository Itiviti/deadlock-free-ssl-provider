...
public class ServiceName extends ullink.security.krb5.PrincipalName {
    ...
    public ServiceName(String name) throws RealmException {
        this(name, ullink.security.krb5.PrincipalName.KRB_NT_UNKNOWN);
    }
    ...
    {
        super(service, instance, realm, ullink.security.krb5.PrincipalName.KRB_NT_SRV_INST);
    }
