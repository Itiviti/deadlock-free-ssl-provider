...
import ullink.security.jca.JCAUtil;
...
implements java.security.interfaces.DSAKeyPairGenerator {
    ...
    public KeyPair generateKeyPair(BigInteger p, BigInteger q, BigInteger g,
        ...
        try {
            ...
            ullink.security.provider.DSAPublicKey pub;
            if (ullink.security.provider.DSAKeyFactory.SERIAL_INTEROP) {
                pub = new ullink.security.provider.DSAPublicKey(y, p, q, g);
            } else {
                pub = new ullink.security.provider.DSAPublicKeyImpl(y, p, q, g);
            }
            ullink.security.provider.DSAPrivateKey priv = new ullink.security.provider.DSAPrivateKey(x, p, q, g);
    ...
    BigInteger generateX(int[] seed, BigInteger q) {
        ...
        int[] tmp = ullink.security.provider.DSA.SHA_7(seed, t);
