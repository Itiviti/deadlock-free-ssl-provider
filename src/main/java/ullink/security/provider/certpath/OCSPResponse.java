...
import ullink.security.x509.Extension;
...
public final class OCSPResponse {
    ...
    private final Map<ullink.security.provider.certpath.CertId, SingleResponse> singleResponseMap;
    ...
    OCSPResponse(byte[] bytes, Date dateCheckedAgainst,
        ...
        singleResponseMap
            = new HashMap<ullink.security.provider.certpath.CertId, SingleResponse>(singleResponseDer.length);
        if (DEBUG != null) {
     ...
     */
    SingleResponse getSingleResponse(ullink.security.provider.certpath.CertId certId) {
     ...
     */
    final static class SingleResponse implements ullink.security.provider.certpath.OCSP.RevocationStatus {
        private final ullink.security.provider.certpath.CertId certId;
        ...
        private SingleResponse(DerValue der) throws IOException {
            ...
            certId = new ullink.security.provider.certpath.CertId(tmp.getDerValue().data);
        ...
        private ullink.security.provider.certpath.CertId getCertId() {
            return certId;
        }
