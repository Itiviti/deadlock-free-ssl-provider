...
import static ullink.security.provider.certpath.OCSPResponse.ResponseStatus;
import static ullink.security.provider.certpath.OCSPResponse.SingleResponse;
...
public final class OCSP {
    ...
    public static RevocationStatus check(X509Certificate cert,
        ...
        try {
            ...
            certId = new ullink.security.provider.certpath.CertId(issuerCert, certImpl.getSerialNumberObject());
        ...
        ullink.security.provider.certpath.OCSPResponse ocspResponse = check(Collections.singletonList(certId),
     ...
     *    encoding the OCSP Request or validating the OCSP Response
     */
    static ullink.security.provider.certpath.OCSPResponse check(List<ullink.security.provider.certpath.CertId> certIds, URI responderURI,
        ...
        ullink.security.provider.certpath.OCSPResponse ocspResponse = null;
        try {
            ocspResponse = new ullink.security.provider.certpath.OCSPResponse(response, date, responderCert);
        } catch (IOException ioe) {
        ...
        for (ullink.security.provider.certpath.CertId certId : certIds) {
    ...
    public static URI getResponderURI(X509Certificate cert) {
        try {
            return getResponderURI(ullink.security.x509.X509CertImpl.toImpl(cert));
        } catch (CertificateException ce) {
    ...
    static URI getResponderURI(ullink.security.x509.X509CertImpl certImpl) {
