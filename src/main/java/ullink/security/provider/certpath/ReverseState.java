...
import ullink.security.x509.NameConstraintsExtension;
import ullink.security.x509.SubjectKeyIdentifierExtension;
import ullink.security.x509.X509CertImpl;
...
class ReverseState implements State {
    ...
    int certIndex;
    ullink.security.provider.certpath.PolicyNodeImpl rootNode;
        ...
        throws CertPathValidatorException
    {
        ...
        rootNode = new ullink.security.provider.certpath.PolicyNodeImpl
            (null, ullink.security.provider.certpath.PolicyChecker.ANY_POLICY, null, false, initExpPolSet, false);
    ...
    public void updateState(X509Certificate cert)
        ...
        if (newKey instanceof DSAPublicKey &&
            ...
            newKey = ullink.security.provider.certpath.BasicChecker.makeInheritedParamsKey(newKey, pubKey);
        }
        ...
        /* update crlSign */
        crlSign = ullink.security.provider.certpath.CrlRevocationChecker.certCanSignCrl(cert);
        ...
        explicitPolicy =
            ullink.security.provider.certpath.PolicyChecker.mergeExplicitPolicy(explicitPolicy, icert, false);
        policyMapping =
            ullink.security.provider.certpath.PolicyChecker.mergePolicyMapping(policyMapping, icert);
        inhibitAnyPolicy =
            ullink.security.provider.certpath.PolicyChecker.mergeInhibitAnyPolicy(inhibitAnyPolicy, icert);
        certIndex++;
         ...
         */
        remainingCACerts =
            ullink.security.provider.certpath.ConstraintsChecker.mergeBasicConstraints(cert, remainingCACerts);
