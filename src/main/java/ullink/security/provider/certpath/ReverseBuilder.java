...
import ullink.security.x509.PolicyMappingsExtension;
...
class ReverseBuilder extends Builder {
    ...
    ReverseBuilder(PKIXBuilderParameters buildParams,
        ...
        if (initialPolicies.isEmpty()) {
            ...
            initPolicies.add(ullink.security.provider.certpath.PolicyChecker.ANY_POLICY);
        } else {
    ...
    Collection<X509Certificate> getMatchingCerts
        (ullink.security.provider.certpath.State currState, List<CertStore> certStores)
        throws CertStoreException, CertificateException, IOException
    {
        ullink.security.provider.certpath.ReverseState currentState = (ullink.security.provider.certpath.ReverseState) currState;
    ...
    private Collection<X509Certificate> getMatchingEECerts
        (ullink.security.provider.certpath.ReverseState currentState, List<CertStore> certStores)
        throws CertStoreException, CertificateException, IOException {
     ...
     */
    void verifyCert(X509Certificate cert, ullink.security.provider.certpath.State currState,
        ...
        throws GeneralSecurityException
    {
        ...
        currentState.rootNode = ullink.security.provider.certpath.PolicyChecker.processPolicies
