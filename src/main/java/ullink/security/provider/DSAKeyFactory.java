...
public class DSAKeyFactory extends KeyFactorySpi {
    ...
    static {
         ...
         * JDK 1.4.
         *
         * If true, then we generate DSAPublicKey.
         * If false, then we generate DSAPublicKeyImpl.
         *
        ...
        try {
            if (keySpec instanceof DSAPublicKeySpec) {
                ...
                if (SERIAL_INTEROP) {
                    ...
                    return new ullink.security.provider.DSAPublicKeyImpl(dsaPubKeySpec.getY(),
                                        dsaPubKeySpec.getP(),
                                        dsaPubKeySpec.getQ(),
                                        dsaPubKeySpec.getG());
                }
                ...
                if (SERIAL_INTEROP) {
                    ...
                    return new ullink.security.provider.DSAPublicKeyImpl
                        (((X509EncodedKeySpec)keySpec).getEncoded());
                }
            } else {
    ...
    throws InvalidKeySpecException {
        try {
            if (keySpec instanceof DSAPrivateKeySpec) {
                ...
                return new ullink.security.provider.DSAPrivateKey(dsaPrivKeySpec.getX(),
                                         dsaPrivKeySpec.getP(),
                                         dsaPrivKeySpec.getQ(),
                                         dsaPrivKeySpec.getG());

            } else if (keySpec instanceof PKCS8EncodedKeySpec) {
                return new ullink.security.provider.DSAPrivateKey
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                // Check if key originates from this factory
                if (key instanceof ullink.security.provider.DSAPrivateKey) {
                    return key;
                }
                // Convert key to spec
