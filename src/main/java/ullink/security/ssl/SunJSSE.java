...
public abstract class SunJSSE extends java.security.Provider {
    ...
    private void doRegister(boolean isfips) {
        ...
        put("Signature.MD5andSHA1withRSA",
            "ullink.security.ssl.RSASignature");

        put("KeyManagerFactory.SunX509",
            "ullink.security.ssl.KeyManagerFactoryImpl$SunX509");
        put("KeyManagerFactory.NewSunX509",
            "ullink.security.ssl.KeyManagerFactoryImpl$X509");
        put("TrustManagerFactory.SunX509",
            "ullink.security.ssl.TrustManagerFactoryImpl$SimpleFactory");
        put("TrustManagerFactory.PKIX",
            "ullink.security.ssl.TrustManagerFactoryImpl$PKIXFactory");
        put("Alg.Alias.TrustManagerFactory.SunPKIX", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X509", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X.509", "PKIX");
        if (isfips == false) {
            put("SSLContext.SSL",
                "ullink.security.ssl.SSLContextImpl");
        ...
        put("SSLContext.Default",
            "ullink.security.ssl.DefaultSSLContextImpl");
    ...
    private void subclassCheck() {
        if (getClass() != ullink.security.Provider.class) {
