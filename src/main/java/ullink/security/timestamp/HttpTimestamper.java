...
package ullink.security.timestamp;
...
public class HttpTimestamper implements Timestamper {
     ...
     */
    public ullink.security.timestamp.TSResponse generateTimestamp(ullink.security.timestamp.TSRequest tsQuery) throws IOException {
        ...
        return new ullink.security.timestamp.TSResponse(replyBuffer);
    }
