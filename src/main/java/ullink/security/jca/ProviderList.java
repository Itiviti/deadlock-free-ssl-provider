...
public final class ProviderList {
    ...
    public List<Service> getServices(String type, List<String> algorithms) {
        List<ullink.security.jca.ServiceId> ids = new ArrayList<ullink.security.jca.ServiceId>();
        for (String alg : algorithms) {
            ids.add(new ullink.security.jca.ServiceId(type, alg));
        }
        return getServices(ids);
    }

    public List<Service> getServices(List<ullink.security.jca.ServiceId> ids) {
    ...
    private final class ServiceList extends AbstractList<Service> {
        ...
        private final List<ullink.security.jca.ServiceId> ids;
        ...
        ServiceList(List<ullink.security.jca.ServiceId> ids) {
            this.type = null;
            this.algorithm = null;
            this.ids = ids;
        }
        ...
        private Service tryGet(int index) {
            while (true) {
                ...
                if (type != null) {
                    ...
                    // parallel lookup
                    for (ullink.security.jca.ServiceId id : ids) {
