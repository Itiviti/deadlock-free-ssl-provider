...
public class GetInstance {
    ...
    public static Service getService(String type, String algorithm)
        ...
        ullink.security.jca.ProviderList list = ullink.security.jca.Providers.getProviderList();
    ...
    public static Service getService(String type, String algorithm,
        ...
        Provider p = ullink.security.jca.Providers.getProviderList().getProvider(provider);
        if (p == null) {
