 ...
 *
 * @see ullink.security.rsa.RSAPrivateCrtKeyImpl
 * @see RSAKeyFactory
 *
 * @since   1.5
...
public final class RSAPublicKeyImpl extends X509Key implements RSAPublicKey {
    ...
    public RSAPublicKeyImpl(BigInteger n, BigInteger e)
        ...
        algid = ullink.security.rsa.RSAPrivateCrtKeyImpl.rsaId;
        try {
    ...
    protected void parseKeyBits() throws InvalidKeyException {
        try {
            ...
            n = ullink.security.rsa.RSAPrivateCrtKeyImpl.getBigInteger(data);
            e = ullink.security.rsa.RSAPrivateCrtKeyImpl.getBigInteger(data);
