...
import ullink.security.pkcs11.Secmod.DbMode;
import ullink.security.pkcs11.Secmod.Module;
import ullink.security.pkcs11.Secmod.ModuleType;
import ullink.security.pkcs11.wrapper.*;
import ullink.security.util.Debug;
import ullink.security.util.ResourcesMgr;
...
public final class SunPKCS11 extends AuthProvider {
    ...
    static {
        ...
        String P11Digest           = "ullink.security.pkcs11.P11Digest";
        String P11MAC              = "ullink.security.pkcs11.P11MAC";
        String P11KeyPairGenerator = "ullink.security.pkcs11.P11KeyPairGenerator";
        String P11KeyGenerator     = "ullink.security.pkcs11.P11KeyGenerator";
        String P11RSAKeyFactory    = "ullink.security.pkcs11.P11RSAKeyFactory";
        String P11DSAKeyFactory    = "ullink.security.pkcs11.P11DSAKeyFactory";
        String P11DHKeyFactory     = "ullink.security.pkcs11.P11DHKeyFactory";
        String P11KeyAgreement     = "ullink.security.pkcs11.P11KeyAgreement";
        String P11SecretKeyFactory = "ullink.security.pkcs11.P11SecretKeyFactory";
        String P11Cipher           = "ullink.security.pkcs11.P11Cipher";
        String P11RSACipher        = "ullink.security.pkcs11.P11RSACipher";
        String P11Signature        = "ullink.security.pkcs11.P11Signature";
        ...
        d(AGP, "EC",            "ECParameters", s("1.2.840.10045.2.1"),
                m(CKM_EC_KEY_PAIR_GEN, CKM_ECDH1_DERIVE, CKM_ECDSA, CKM_ECDSA_SHA1));

        d(KA, "DH",             P11KeyAgreement,        s("DiffieHellman"),
                m(CKM_DH_PKCS_DERIVE));
        d(KA, "ECDH",           "ullink.security.pkcs11.P11ECDHKeyAgreement",
                m(CKM_ECDH1_DERIVE));
        ...
        d(KG, "SunTlsRsaPremasterSecret", "ullink.security.pkcs11.P11TlsRsaPremasterSecretGenerator",
                m(CKM_SSL3_PRE_MASTER_KEY_GEN, CKM_TLS_PRE_MASTER_KEY_GEN));
        d(KG, "SunTlsMasterSecret", "ullink.security.pkcs11.P11TlsMasterSecretGenerator",
                m(CKM_SSL3_MASTER_KEY_DERIVE, CKM_TLS_MASTER_KEY_DERIVE,
                    CKM_SSL3_MASTER_KEY_DERIVE_DH, CKM_TLS_MASTER_KEY_DERIVE_DH));
        d(KG, "SunTlsKeyMaterial", "ullink.security.pkcs11.P11TlsKeyMaterialGenerator",
                m(CKM_SSL3_KEY_AND_MAC_DERIVE, CKM_TLS_KEY_AND_MAC_DERIVE));
        d(KG, "SunTlsPrf", "ullink.security.pkcs11.P11TlsPrfGenerator",
            ...
            public Object run() {
                ...
                if (((token.tokenInfo.flags & CKF_RNG) != 0)
                    ...
                    putService(new P11Service(token, SR, "PKCS11",
                        "ullink.security.pkcs11.P11SecureRandom", null,
                        PCKM_SECURERANDOM));
                }
                if (config.isEnabled(PCKM_KEYSTORE)) {
                    putService(new P11Service(token, KS, "PKCS11",
                        "ullink.security.pkcs11.P11KeyStore",
