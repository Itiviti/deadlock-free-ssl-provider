...
import ullink.security.util.PropertyExpander;
...
import static ullink.security.pkcs11.TemplateManager.O_ANY;
import static ullink.security.pkcs11.wrapper.CK_ATTRIBUTE.*;
...
final class Config {
    ...
    static {
        String p = "ullink.security.pkcs11.allowSingleThreadedModules";
