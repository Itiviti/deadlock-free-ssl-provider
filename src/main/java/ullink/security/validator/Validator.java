 ...
 * </pre>
 *
 * @see ullink.security.validator.SimpleValidator
 * @see ullink.security.validator.PKIXValidator
...
public abstract class Validator {
    ...
    public static Validator getInstance(String type, String variant,
            KeyStore ks) {
        return getInstance(type, variant, ullink.security.validator.KeyStores.getTrustedCerts(ks));
    }
    ...
    public static Validator getInstance(String type, String variant,
        ...
        if (type.equals(TYPE_SIMPLE)) {
            return new ullink.security.validator.SimpleValidator(variant, trustedCerts);
        } else if (type.equals(TYPE_PKIX)) {
            return new ullink.security.validator.PKIXValidator(variant, trustedCerts);
        } else {
    ...
    public static Validator getInstance(String type, String variant,
        ...
        return new ullink.security.validator.PKIXValidator(variant, params);
    }
